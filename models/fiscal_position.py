...
class FiscalPosition(db.Model):
    ...
    __table_args__ = (db.UniqueConstraint("tenant_id", "code", name="uq_fiscal_pos_tenant_code"),)
    ...
    def map_tax(self, source_tax_id):
        ...
        rule = FiscalPositionTaxRule.query.filter_by(fiscal_position_id=self.id, source_tax_id=source_tax_id).first()
