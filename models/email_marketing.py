...
class EmailSubscriber(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    tenant_id = db.Column(db.Integer, db.ForeignKey('tenants.id', ondelete='CASCADE'), nullable=False, index=True)
    list_id = db.Column(db.Integer, db.ForeignKey('email_lists.id', ondelete='CASCADE'), nullable=False, index=True)
...
class EmailCampaign(db.Model):
    ...
    list_id = db.Column(db.Integer, db.ForeignKey('email_lists.id', ondelete='SET NULL'), nullable=True, index=True)
...
class CampaignLog(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    tenant_id = db.Column(db.Integer, db.ForeignKey('tenants.id', ondelete='CASCADE'), nullable=False, index=True)
    campaign_id = db.Column(db.Integer, db.ForeignKey('email_campaigns.id', ondelete='CASCADE'), nullable=False, index=True)
    subscriber_id = db.Column(db.Integer, db.ForeignKey('email_subscribers.id', ondelete='CASCADE'), nullable=False)
