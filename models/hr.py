...
class HRContract(db.Model):
    ...
    job_id = db.Column(db.Integer, db.ForeignKey("job_positions.id", ondelete="SET NULL"), nullable=True, index=True)
...
class LeaveRequest(db.Model):
    ...
    leave_type_id = db.Column(
        db.Integer, db.ForeignKey("leave_types.id", ondelete="SET NULL"), nullable=True, index=True
    )
