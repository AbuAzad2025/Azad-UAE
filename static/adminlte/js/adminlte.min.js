...
!((e, t) => {
				...
				(t.load = function () {
					this._addOverlay(),
						...
						n.default
							.get(
								...
								(t) => {
									this._settings.loadInContent &&
										...
										this._settings.onLoadDone.call(n.default(this), t),
										this._removeOverlay();
								},
							...
							.fail((t, a, i) => {
								if ((this._removeOverlay(), this._settings.loadErrorTemplate)) {
									var o = n.default(this._settings.errorTemplate).text(i);
									this._parent.find(this._settings.content).empty().append(o);
								}
								this._settings.onLoadFail.call(n.default(this), t, a, i);
							}),
						n
	...
	n.default(document).on("click", r, function (e) {
		...
		(n.default.fn[i].noConflict = () => (
			(n.default.fn[i] = l), f._jQueryInterface
		));
	var u = "CardWidget",
		c = "lte.cardwidget",
		h = n.default.fn[u],
				...
				(t.collapse = function () {
					this._parent
						...
						.slideUp(this._settings.animationSpeed, () => {
							this._parent.addClass(p).removeClass(m);
						}),
						this._parent
							.find(
								"> .card-header " +
				...
				(t.expand = function () {
					this._parent
						...
						.slideDown(this._settings.animationSpeed, () => {
							this._parent.removeClass(p).removeClass(v);
						}),
						this._parent
							.find(
								"> .card-header " +
	...
	n.default(document).on("click", C, function (e) {
		...
		(n.default.fn[u].noConflict = () => (
			(n.default.fn[u] = h), I._jQueryInterface
		));
			...
			return (
				(t.collapse = function () {
					...
					this._config.controlsidebarSlide
						...
						setTimeout(() => {
							n.default(this._element).trigger(
				...
				(t._init = function () {
					...
					t.hasClass(L) || t.hasClass(D)
						...
						n.default(window).resize(() => {
							this._fixHeight(), this._fixScrollHeight();
						}),
						n.default(window).scroll(() => {
							var t = n.default("body");
							(t.hasClass(L) || t.hasClass(D)) && this._fixScrollHeight();
						});
				}),
				(t._isNavbarFixed = () => {
					var e = n.default("body");
	...
	n
		...
		(n.default.fn[q].noConflict = () => (
			(n.default.fn[q] = N), P._jQueryInterface
		));
	var U = "Dropdown",
		B = "lte.dropdown",
		$ = n.default.fn[U],
	...
	n
		...
		n.default('.navbar [data-toggle="dropdown"]').on("click", (e) => {
			e.preventDefault(),
	...
	n.default(".expandable-table").ready(function () {
		...
		(n.default.fn[G].noConflict = () => (
			(n.default.fn[G] = X), te._jQueryInterface
		));
	var ae = "Fullscreen",
		ne = "lte.fullscreen",
		ie = n.default.fn[ae],
	...
	n.default(document).on("click", oe, function () {
		...
		(n.default.fn[ae].noConflict = () => (
			(n.default.fn[ae] = ie), re._jQueryInterface
		));
	var de = "lte.iframe",
			...
			return (
				...
				(t.createTab = function (e, t, a, i) {
					...
					if ((n.default(be).append(unescape(escape(d))), i))
						if (this._config.loadingScreen) {
							var f = n.default(Ce);
							f.fadeIn(),
								n.default(l + " iframe").ready(() => {
									"number" == typeof this._config.loadingScreen
										? (this.switchTab("#" + s),
											setTimeout(() => {
												f.fadeOut();
											}, this._config.loadingScreen))
										: (this.switchTab("#" + s), f.fadeOut());
								});
				...
				(t._setupListeners = function () {
					n.default(window).on("resize", () => {
						...
						n.default(he).hasClass(Se) &&
							(n
								...
								.on(
									...
									(t) => {
										t.preventDefault(), this.openTabSidebar(t.target);
									},
								),
							this._config.useNavbarItems &&
								n.default(document).on("click", Ie + ", " + Te, (t) => {
									t.preventDefault(), this.openTabSidebar(t.target);
								})),
						n.default(document).on("click", _e, (t) => {
							t.preventDefault(),
								this.onTabClick(t.target),
								this.switchTab(t.target);
						}),
						n.default(document).on("click", _e, (t) => {
							t.preventDefault(),
								this.onTabClick(t.target),
						...
						n
							.default(document)
							.on("click", '[data-widget="iframe-close"]', (t) => {
								t.preventDefault();
								var a = t.target;
						...
						n.default(document).on("click", ce, (t) => {
					...
					n
						.default(document)
						.on("mousedown", '[data-widget="iframe-scrollleft"]', (n) => {
							n.preventDefault(), clearInterval(a);
							var i = this._config.scrollOffset;
							this._config.scrollBehaviorSwap || (i = -i),
								(t = !0),
								this._navScroll(i),
								(a = setInterval(() => {
									this._navScroll(i);
						...
						n
							.default(document)
							.on("mousedown", '[data-widget="iframe-scrollright"]', (n) => {
								n.preventDefault(), clearInterval(a);
								var i = this._config.scrollOffset;
								this._config.scrollBehaviorSwap && (i = -i),
									(t = !0),
			...
			return (
				...
				(t._init = function () {
					this.fixLayoutHeight(),
						...
						n.default(Ee).on("mouseenter mouseleave", () => {
				...
				(t._isFooterFixed = () => "fixed" === n.default(De).css("position")),
				(e._jQueryInterface = function (t) {
					return (
						void 0 === t && (t = ""),
						this.each(function () {
	...
	n.default(window).on("load", () => {
		...
		(n.default.fn.Layout.noConflict = () => (
			(n.default.fn.Layout = ze), Me._jQueryInterface
		));
	var qe = "PushMenu",
		Oe = "lte.pushmenu",
		Ne = "." + Oe,
		...
		Ke = (() => {
			...
			return (
				...
				(t._addOverlay = function () {
					var t = n.default("<div />", { id: "sidebar-overlay" });
					t.on("click", () => {
						this.collapse();
					}),
	...
	n.default(document).on("click", Ue, (e) => {
		e.preventDefault();
		...
		(n.default.fn[qe].noConflict = () => (
			(n.default.fn[qe] = Pe), Ke._jQueryInterface
		));
	var Xe = "SidebarSearch",
		...
		ht = (() => {
			...
			return (
				...
				(a.search = function () {
					...
					n.default(ft).empty(),
						0 === i.length
							...
							: i.each((t, a) => {
									n.default(ft).append(
										this._renderItem(escape(a.name), encodeURI(a.link), a.path),
									);
								}),
						this.open();
				}),
				...
				(a._trimText = (e) => t.trim(e.replace(/(\r\n|\n|\r)/gm, " "))),
	...
	n.default(document).on("click", st, (e) => {
		e.preventDefault(), ht._jQueryInterface.call(n.default(ot), "toggle");
	}),
		n.default(document).on("keyup", lt, (e) =>
			38 == e.keyCode
		...
		n.default(document).on("keydown", ft, (e) => {
		...
		(n.default.fn[Xe].noConflict = () => (
			(n.default.fn[Xe] = Ze), ht._jQueryInterface
		));
	var gt = "NavbarSearch",
	...
	n.default(document).on("click", vt, (e) => {
		e.preventDefault();
		...
		(n.default.fn[gt].noConflict = () => (
			(n.default.fn[gt] = mt), Ct._jQueryInterface
		));
	...
	(n.default.fn.Toasts = kt._jQueryInterface),
		...
		(n.default.fn.Toasts.noConflict = () => (
			(n.default.fn.Toasts = wt), kt._jQueryInterface
		));
	var Qt = "TodoList",
		Ht = "lte.todolist",
		zt = n.default.fn[Qt],
		Ft = "done",
		Et = { onCheck: (e) => e, onUnCheck: (e) => e },
		Lt = (() => {
			function e(e, t) {
				(this._config = t), (this._element = e), this._init();
			}
			...
			return (
				...
				(t._init = function () {
					...
					t.find("input:checkbox:checked").parents("li").toggleClass(Ft),
						t.on("change", "input:checkbox", (t) => {
							this.toggle(n.default(t.target));
						});
				}),
				(e._jQueryInterface = function (t) {
					return this.each(function () {
	...
	n.default(window).on("load", () => {
		...
		(n.default.fn[Qt].noConflict = () => (
			(n.default.fn[Qt] = zt), Lt._jQueryInterface
		));
	var Dt = "Treeview",
		Rt = "lte.treeview",
		At = n.default.fn[Dt],
		...
		$t = (() => {
			...
			return (
				...
				(t.expand = function (e, t) {
					var i = n.default.Event("expanded.lte.treeview");
					...
					t.addClass(Ut),
						e.stop().slideDown(this._config.animationSpeed, () => {
							t.addClass(Pt), n.default(this._element).trigger(i);
						}),
						this._config.expandSidebar && this._expandSidebar();
				}),
				(t.collapse = function (e, t) {
					var i = n.default.Event("collapsed.lte.treeview");
					t.removeClass("menu-is-opening menu-open"),
						e.stop().slideUp(this._config.animationSpeed, () => {
	...
	n.default(window).on("load.lte.treeview", () => {
		...
		(n.default.fn[Dt].noConflict = () => (
			(n.default.fn[Dt] = At), $t._jQueryInterface
		)),
		(e.CardRefresh = f),
		(e.CardWidget = I),
		(e.ControlSidebar = M),
