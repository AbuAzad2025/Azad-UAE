...
!((e, t) => {
	...
	var t = [],
		...
		s = t.slice,
		v = t.flat ? (e) => t.flat.call(e) : (e) => t.concat.apply([], e),
		u = t.push,
		i = t.indexOf,
		n = {},
		o = n.toString,
	...
	var p = ((n) => {
		...
		(se.contains = (e, t) => ((e.ownerDocument || e) != T && C(e), y(e, t))),
		(se.attr = (e, t) => {
		...
		E.each(
			{
				...
				siblings: (e) => A((e.parentNode || {}).firstChild, e),
				children: (e) => A(e.firstChild),
				contents: (e) =>
	...
	(E.Callbacks = (r) => {
		...
		var i,
			...
			f = {
				...
				has: (e) => (e ? -1 < E.inArray(e, s) : 0 < s.length),
				empty: function () {
					return s && (s = []), this;
				},
				disable: function () {
			...
			Deferred: (e) => {
				var o = [
					...
					a = {
						...
						promise: (e) => (null != e ? E.extend(e, a) : a),
					},
					s = {};
				return (
					E.each(o, (e, t) => {
	...
	var X = (e) => 1 === e.nodeType || 9 === e.nodeType || !+e.nodeType;
	function Q() {
	...
	E.extend({
		hasData: (e) => G.hasData(e) || Y.hasData(e),
		data: (e, t, n) => G.access(e, t, n),
		removeData: (e, t) => {
			G.remove(e, t);
		},
	...
	var ee = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		...
		ie = (e) => E.contains(e.ownerDocument, e),
		oe = { composed: !0 };
	re.getRootNode &&
		(ie = (e) =>
	...
	E.extend({
		...
		(E.cssHooks.marginLeft = Me(m.reliableMarginLeft, (e, t) => {
			if (t)
				return (
	...
	(E.param = (e, t) => {
		...
		E.each(["top", "left"], (e, n) => {
			E.cssHooks[n] = Me(m.pixelPosition, (e, t) => {
				if (t)
	...
	(E.proxy = function (e, t) {
		...
		(E.trim = (e) => (null == e ? "" : (e + "").replace(gt, ""))),
		"function" == typeof define && define.amd && define("jquery", [], () => E);
	var vt = g.jQuery,
		yt = g.$;
	return (
		(E.noConflict = (e) => (
			g.$ === E && (g.$ = yt), e && g.jQuery === E && (g.jQuery = vt), E
		)),
