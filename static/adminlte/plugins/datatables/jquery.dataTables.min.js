...
((l) => {
	"function" === typeof define && define.amd
		? define(["jquery"], (z) => l(z, window, document))
	...
	function Ga(a, b, c) {
		...
		c = (m) => "string" === typeof m && -1 !== m.indexOf("@");
	...
	function Kb(a) {
		...
		l(a.nTable).on("search.dt.DT", (n, p) => {
			if (a === p)
				try {
	...
	function za(a, b, c) {
		var d = a.oPreviousSearch,
			...
			f = (g) => (g.bEscapeRegex !== q ? !g.bEscapeRegex : g.bRegex);
		$a(a);
		if ("ssp" != Q(a)) {
	...
	function Jb(a) {
		...
		l(a.nTable).on("length.dt.DT", (m, n, p) => {
	...
	function dc(a, b, c) {
		if (a.oFeatures.bStateSave)
			return (
				(b = a.fnStateLoadCallback.call(a.oInstance, a, (d) => {
					pb(a, d, c);
				})),
				b !== q && pb(a, b, c),
				!0
	...
	function F(a, b, c, d) {
		var e = [];
		b &&
			(e = l.map(a[b].slice().reverse(), (h, f) => h.fn.apply(a.oInstance, d)));
		null !== c &&
		...
		l.each(
			{
				num: (b) => Ua(b, a),
				"num-fmt": (b) => Ua(b, a, rb),
				"html-num": (b) => Ua(b, a, Va),
				"html-num-fmt": (b) => Ua(b, a, Va, rb),
			},
			(b, c) => {
	...
	var u = function (a, b) {
			...
			this.each(function () {
				...
				if ("table" != this.nodeName.toLowerCase())
					...
					Db(r, g.aoColumnDefs, v, (I, H) => {
						Ga(r, I, H);
					});
					if (aa.length) {
						var L = (I, H) => (null !== I.getAttribute("data-" + H) ? H : null);
						l(aa[0])
							.children("th, td")
							.each((I, H) => {
	...
	u.util = {
		...
		get: (a) => {
			...
			if (null === a) return (d) => d;
			if ("function" === typeof a) return (d, e, h, f) => a(d, e, h, f);
			if (
				"string" !== typeof a ||
				(-1 === a.indexOf(".") &&
					-1 === a.indexOf("[") &&
	...
	var oc = (a, b) => {
		if (Array.isArray(a)) return l.map(a, (d) => oc(d, b));
		if ("number" === typeof a) return [b[a]];
		var c = l.map(b, (d, e) => d.nTable);
		return l(c)
			.filter(a)
			.map(function (d) {
				d = l.inArray(this, c);
	...
	J("tables().nodes()", "table().node()", function () {
		return this.iterator("table", (a) => a.nTable, 1);
	});
	J("tables().body()", "table().body()", function () {
		return this.iterator("table", (a) => a.nTBody, 1);
	});
	J("tables().header()", "table().header()", function () {
		return this.iterator("table", (a) => a.nTHead, 1);
	});
	J("tables().footer()", "table().footer()", function () {
		return this.iterator("table", (a) => a.nTFoot, 1);
	});
	J("tables().containers()", "table().container()", function () {
		return this.iterator("table", (a) => a.nTableWrapper, 1);
	});
	y("draw()", function (a) {
			...
			if ("current" == b)
				...
				if ("none" == h) c = e.slice();
					...
					if ("removed" == h) {
						...
						c = l.map(e, (k) => (Object.hasOwn(g, k) ? null : k));
					}
				}
	...
	y("rows()", function (a, b) {
		...
		b = vb(b);
		var c = this.iterator("table", (d) => xc(d, a, b), 1);
		c.selector.rows = a;
		c.selector.opts = b;
		return c;
	});
	y("rows().nodes()", function () {
		return this.iterator("row", (a, b) => a.aoData[b].nTr || q, 1);
	});
	y("rows().data()", function () {
		return this.iterator(!0, "rows", (a, b) => Ea(a.aoData, b, "_aData"), 1);
	});
	...
	J("rows().indexes()", "row().index()", function () {
		return this.iterator("row", (a, b) => b, 1);
	});
	...
	y("row.add()", function (a) {
		...
		var b = this.iterator("table", (c) =>
			a.nodeName && "TR" === a.nodeName.toUpperCase() ? Ja(c, a)[0] : ia(c, a),
		);
		return this.row(b[0]);
	});
	l(A).on("plugin-init.dt", (a, b) => {
		var c = new B(b);
		c.on("stateSaveParams", (d, e, h) => {
			d = c
				.rows()
				.iterator("row", (f, g) => (f.aoData[g]._detailsShow ? g : q));
	...
	var yc = (a, b, c, d) => {
		...
		zc = (a) => {
			...
			0 < U(c, "_details").length &&
				...
				b.on("column-visibility.dt.DT_details", (d, e, h, f) => {
					if (a === e)
				...
				b.on("destroy.dt.DT_details", (d, e) => {
					if (a === e)
					...
					if (m)
						switch (m[2]) {
							...
							case "visible":
								g = parseInt(m[1], 10);
								if (0 > g) {
									var n = l.map(d, (p, t) => (p.bVisible ? t : null));
									return [n[n.length + g]];
								}
								return [ua(a, g)];
							case "name":
								return l.map(e, (p, t) => (p === m[1] ? t : null));
							default:
								return [];
						}
	...
	y("columns()", function (a, b) {
		a === q ? (a = "") : l.isPlainObject(a) && ((b = a), (a = ""));
		b = vb(b);
		var c = this.iterator("table", (d) => Bc(d, a, b), 1);
		c.selector.cols = a;
		c.selector.opts = b;
		return c;
	});
	J("columns().header()", "column().header()", function (a, b) {
		return this.iterator("column", (c, d) => c.aoColumns[d].nTh, 1);
	});
	J("columns().footer()", "column().footer()", function (a, b) {
		return this.iterator("column", (c, d) => c.aoColumns[d].nTf, 1);
	});
	J("columns().data()", "column().data()", function () {
		return this.iterator("column-rows", rc, 1);
	});
	J("columns().dataSrc()", "column().dataSrc()", function () {
		return this.iterator("column", (a, b) => a.aoColumns[b].mData, 1);
	});
	J("columns().cache()", "column().cache()", function (a) {
		return this.iterator(
			"column-rows",
			(b, c, d, e, h) =>
				Ea(b.aoData, h, "search" === a ? "_aFilterData" : "_aSortData", c),
			1,
		);
	});
	J("columns().nodes()", "column().nodes()", function () {
		return this.iterator(
			"column-rows",
			(a, b, c, d, e) => Ea(a.aoData, e, "anCells", b),
			1,
		);
	});
	J("columns().visible()", "column().visible()", function (a, b) {
		var d = this.iterator("column", (e, h) => {
		...
		a !== q &&
			this.iterator("table", (e) => {
				...
				qa(e);
				this.iterator("column", (h, f) => {
					F(h, null, "column-visibility", [h, f, a, b]);
				});
				(b === q || b) && this.columns.adjust();
			});
		return d;
	});
	...
	y("cells()", function (a, b, c) {
		...
		if (null === b || b === q)
			return this.iterator("table", (n) => Cc(n, a, vb(c)));
	...
	J("cells().nodes()", "cell().node()", function () {
		return this.iterator(
			"cell",
			(a, b, c) => ((a = a.aoData[b]) && a.anCells ? a.anCells[c] : q),
			1,
		);
	});
	y("cells().data()", function () {
		return this.iterator("cell", (a, b, c) => T(a, b, c), 1);
	});
	J("cells().cache()", "cell().cache()", function (a) {
		a = "search" === a ? "_aFilterData" : "_aSortData";
		return this.iterator("cell", (b, c, d) => b.aoData[c][a][d], 1);
	});
	J("cells().render()", "cell().render()", function (a) {
		return this.iterator("cell", (b, c, d) => T(b, c, d, a), 1);
	});
	J("cells().indexes()", "cell().index()", function () {
		return this.iterator(
			"cell",
			(a, b, c) => ({ row: b, column: c, columnVisible: va(a, c) }),
			1,
		);
	});
	...
	J("columns().search()", "column().search()", function (a, b, c, d) {
		return this.iterator("column", (e, h) => {
	...
	u.versionCheck = u.fnVersionCheck = (a) => {
	...
	u.isDataTable = u.fnIsDataTable = (a) => {
		var b = l(a).get(0),
			c = !1;
		if (a instanceof u.Api) return !0;
		l.each(u.settings, (d, e) => {
	...
	u.tables = u.fnTables = (a) => {
		var b = !1;
		l.isPlainObject(a) && ((b = a.api), (a = a.visible));
		var c = l.map(u.settings, (d) => {
	...
	l.each(["on", "one", "off"], (a, b) => {
		y(b + "()", function () {
			var c = Array.prototype.slice.call(arguments);
			c[0] = l
				.map(c[0].split(/\s/), (e) => (e.match(/\.dt\b/) ? e : e + ".dt"))
				.join(" ");
	...
	y("data()", function () {
		return this.iterator("table", (a) => U(a.aoData, "_aData")).flatten();
	});
	...
	l.each(["column", "row", "cell"], (a, b) => {
		y(b + "s().every()", function (c) {
			var d = this.selector.opts;
			return this.iterator(b, (h, f, g, k, m) => {
				c.call(
					this[b](f, "cell" === b ? g : d, "cell" === b ? d : q),
					f,
					g,
					k,
					m,
	...
	var ec = u.ext.pager;
	l.extend(ec, {
		simple: (a, b) => ["previous", "next"],
		full: (a, b) => ["first", "previous", "next", "last"],
		numbers: (a, b) => [Da(a, b)],
		simple_numbers: (a, b) => ["previous", Da(a, b), "next"],
		full_numbers: (a, b) => ["first", "previous", Da(a, b), "next", "last"],
		first_last_numbers: (a, b) => ["first", Da(a, b), "last"],
		_numbers: Da,
		numbers_length: 7,
	});
	...
	l.extend(u.ext.type.detect, [
		...
		(a, b) =>
			Z(a) || ("string" === typeof a && -1 !== a.indexOf("<")) ? "html" : null,
	]);
		...
		html: (a) =>
			Z(a)
				...
				: "string" === typeof a
					...
					: "",
		string: (a) => (Z(a) ? a : "string" === typeof a ? a.replace(gc, " ") : a),
	});
	var Ua = (a, b, c, d) => {
	...
	l.extend(M.type.order, {
		...
		"html-pre": (a) =>
			Z(a) ? "" : a.replace ? a.replace(/<.*?>/g, "").toLowerCase() : a + "",
		"string-pre": (a) =>
			Z(a)
				? ""
				: "string" === typeof a
	...
	l.extend(!0, u.ext.renderer, {
		header: {
			_: (a, b, c, d) => {
				l(a.nTable).on("order.dt.DT", (e, h, f, g) => {
					a === h &&
						((e = c.idx),
						b
	...
	l.extend(u.ext.internal, {
		...
		_fnAddData: ia,
		_fnAddTr: Ja,
		_fnNodeToDataIndex: (a, b) =>
			b._DT_RowIndex !== q ? b._DT_RowIndex : null,
		_fnNodeToColumnIndex: (a, b, c) => l.inArray(c, a.aoData[b].anCells),
		_fnGetCellData: T,
		_fnSetCellData: Eb,
