...
((b) => {
	"function" === typeof define && define.amd
		? define(["jquery", "datatables.net", "datatables.net-buttons"], (d) =>
				b(d, window, document),
			)
	...
	u.ext.buttons.print = {
		...
		text: (a) => a.i18n("buttons.print", "Print"),
		action: (a, e, p, k) => {
			...
			var w = e
					...
					.flatten()
					.map((f) => e.settings()[0].aoColumns[e.column(f).index()].sClass)
					.toArray(),
				r = (f, g) => {
			...
			if (c) {
				...
				b("img", c.document.body).each((f, g) => {
