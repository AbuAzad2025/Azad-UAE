...
var $jscomp$lookupPolyfilledValue = (a, b) => {
	var c = $jscomp.propertyToPolyfillSymbol[b];
	if (null == c) return a[b];
	c = a[c];
	return void 0 !== c ? c : a[b];
};
$jscomp.polyfill = (a, b, c, e) => {
	b &&
...
((a) => {
	"function" === typeof define && define.amd
		? define(["jquery", "datatables.net"], (b) => a(b, window, document))
	...
	d.ext.renderer.pageButton.bootstrap = (f, l, A, B, m, t) => {
		var u = new d.Api(f),
			C = f.oClasses,
