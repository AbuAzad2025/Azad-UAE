...
!((t, e) => {
	...
	function s(t, e) {
		return (
			(s = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t))), s(t, e)
		);
	}
	var l = "transitionend";
	var u = {
		...
		supportsTransitionEnd: () => Boolean(l),
	...
	u.jQueryDetection(),
		(i.default.fn.emulateTransitionEnd = function (t) {
			var n = !1;
			return (
				i.default(this).one(u.TRANSITION_END, () => {
					n = !0;
				}),
				setTimeout(() => {
					n || u.triggerTransitionEnd(this);
				}, t),
				this
			);
		}),
			...
			return (
				...
				(e._removeElement = function (t) {
					if (
						...
						i.default(t)
							.one(u.TRANSITION_END, (n) => this._destroyElement(t, n))
				...
				r(t, null, [{ key: "VERSION", get: () => "4.6.1" }]),
				t
			);
		})();
	i
		...
		(i.default.fn.alert.noConflict = () => (
			(i.default.fn.alert = d), c._jQueryInterface
		));
	var h = "bs.button",
	...
	i
		.default(document)
		.on("click.bs.button.data-api", g, (t) => {
			var e = t.target,
				n = e;
			if (
		...
		.on("focus.bs.button.data-api blur.bs.button.data-api", g, (t) => {
		...
		(i.default.fn.button.noConflict = () => (
			(i.default.fn.button = p), b._jQueryInterface
		));
	var y = "carousel",
		E = "bs.carousel",
		w = i.default.fn[y],
			...
			return (
				...
				(e.to = function (t) {
					...
					if (!(t > this._items.length - 1 || t < 0))
						if (this._isSliding)
							i.default(this._element).one(N, () => this.to(t));
						else {
				...
				(e._getConfig = (t) => (
					(t = a({}, A, t)), u.typeCheckConfig(y, t, k), t
				)),
						...
						i
							...
							this._pointerEvent
								...
								: (i
									...
									i.default(this._element).on("touchmove.bs.carousel", (e) =>
										((e) => {
											this.touchDeltaX =
							...
							i.default(s)
								.one(u.TRANSITION_END, () => {
									i
										...
										(this._isSliding = !1),
										setTimeout(() => i.default(this._element).trigger(h), 0);
								})
	...
	i
		...
		i.default(window).on("load.bs.carousel.data-api", () => {
			for (
				var t = [].slice.call(
		...
		(i.default.fn[y].noConflict = () => (
			(i.default.fn[y] = w), O._jQueryInterface
		));
	var x = "collapse",
		j = "bs.collapse",
		L = i.default.fn[x],
							...
							i
								...
								.one(u.TRANSITION_END, () => {
									i
										...
										i.default(this._element).trigger("shown.bs.collapse");
								})
	...
	i.default(document).on("click.bs.collapse.data-api", q, function (t) {
		...
		(i.default.fn[x].noConflict = () => (
			(i.default.fn[x] = L), W._jQueryInterface
		));
	var U =
	...
	function Et(t, e, n, i, o) {
		...
		var a = bt(n, i, r, o),
			...
			l = Object.keys(s)
				.map((t) => ct({ key: t }, s[t], { area: yt(s[t]) }))
				...
				: t.slice(
						...
						((t, e, n) => {
							if (Array.prototype.findIndex)
								return t.findIndex((t) => t.name === n);
							var i = Nt(t, (t) => t.name === n);
							return t.indexOf(i);
						})(t, 0, n),
					)
			).forEach((t) => {
							...
							(n = Rt(+i)
								...
								: ((t, e, n, i) => {
										var o = [0, 0],
											...
											s = a.indexOf(Nt(a, (t) => -1 !== t.search(/,|\s/)));
										a[s] &&
											-1 === a[s].indexOf(",") &&
											console.warn(
			...
			function t(e, n) {
				...
				ut(this, t),
					...
					(this.modifiers = Object.keys(this.options.modifiers)
						.map((t) => ct({ name: t }, this.options.modifiers[t]))
	...
	var Yt = Vt,
		...
		le = (() => {
			...
			return (
				...
				(e._addEventListeners = function () {
					i.default(this._element).on("click.bs.dropdown", (e) => {
					...
					if (
						...
						if (o || 27 !== e.which) {
							...
							var r = [].slice
								...
								.filter((t) => i.default(t).is(":visible"));
							if (0 !== r.length) {
	...
	i
		...
		.on(ne, ".dropdown form", (t) => {
			t.stopPropagation();
		}),
		(i.default.fn[zt] = le._jQueryInterface),
		(i.default.fn[zt].Constructor = le),
		(i.default.fn[zt].noConflict = () => (
			(i.default.fn[zt] = Xt), le._jQueryInterface
		));
	var ue = "bs.modal",
		...
		Se = (() => {
			...
			return (
					...
					if (!this._isShown && !this._isTransitioning) {
						...
						i.default(this._element).trigger(n),
							n.isDefaultPrevented() ||
								...
								i
									.default(this._element)
									.on(be, '[data-dismiss="modal"]', (t) => this.hide(t)),
								i.default(this._dialog).on(Ee, () => {
									i.default(this._element).one(
										"mouseup.dismiss.bs.modal",
										(t) => {
											i.default(t.target).is(this._element) &&
					...
					if (
						...
						if (
							...
							if (
								...
								i.default(this._element)
									.one(u.TRANSITION_END, (t) => this._hideModal(t))
				...
				(e._showElement = function (t) {
					var n = i.default(this._element).hasClass(ce),
					...
					i.default(document)
						...
						.on(_e, (e) => {
							document !== e.target &&
								...
								0 === i.default(this._element).has(e.target).length &&
								this._element.focus();
						});
				}),
				(e._setEscapeEvent = function () {
					this._isShown
						? i.default(this._element).on(ye, (e) => {
				...
				(e._setResizeEvent = function () {
					this._isShown
						? i.default(window).on(ve, (e) => this.handleUpdate(e))
					...
					(this._element.style.display = "none"),
						...
						this._showBackdrop(() => {
							i.default(document.body).removeClass(de),
								...
								i.default(this._element).trigger(me);
						});
				}),
				...
				(e._showBackdrop = function (t) {
					var n = i.default(this._element).hasClass(ce) ? ce : "";
					if (this._isShown && this._config.backdrop) {
						if (
							...
							i.default(this._element).on(be, (t) => {
	...
	i
		...
		(i.default.fn.modal.noConflict = () => (
			(i.default.fn.modal = fe), Se._jQueryInterface
		));
	var Ne = [
			"background",
			"cite",
	...
	var Ie = "tooltip",
		...
		Ve = (() => {
			...
			return (
				...
				(e.show = function () {
					...
					if (this.isWithContent() && this._isEnabled) {
						...
						var d = () => {
							...
							(this._hoverState = null),
								i.default(this.element).trigger(this.constructor.Event.SHOWN),
								e === He && this._leave(null, this);
						};
					...
					var n = this.getTipElement(),
						...
						r = () => {
							this._hoverState !== Re &&
								...
								i.default(this.element).trigger(this.constructor.Event.HIDDEN),
				...
				(e._getAttachment = (t) => Be[t.toUpperCase()]),
				(e._setListeners = function () {
					this.config.trigger.split(" ").forEach((e) => {
						if ("click" === e)
							i.default(this.element).on(
	...
	(i.default.fn.tooltip = Ve._jQueryInterface),
		...
		(i.default.fn.tooltip.noConflict = () => (
			(i.default.fn.tooltip = xe), Ve._jQueryInterface
		));
	var Ye = "bs.popover",
	...
	(i.default.fn.popover = Je._jQueryInterface),
		...
		(i.default.fn.popover.noConflict = () => (
			(i.default.fn.popover = ze), Je._jQueryInterface
		));
	var Ze = "scrollspy",
		tn = "bs.scrollspy",
		en = i.default.fn[Ze],
		...
		ln = (() => {
			...
			return (
				...
				(e._clear = function () {
					[].slice
						.call(document.querySelectorAll(this._selector))
						.filter((t) => t.classList.contains(nn))
						.forEach((t) => t.classList.remove(nn));
				}),
				(t._jQueryInterface = function (e) {
					return this.each(function () {
	...
	i.default(window).on("load.bs.scrollspy.data-api", () => {
		...
		(i.default.fn[Ze].noConflict = () => (
			(i.default.fn[Ze] = en), ln._jQueryInterface
		));
	var un = "bs.tab",
		fn = i.default.fn.tab,
		dn = "active",
			...
			return (
					...
					if (
						...
						if (
							...
							var f = () => {
								...
								i.default(n).trigger(e), i.default(this._element).trigger(o);
							};
				...
				(e._activate = function (t, e, n) {
					var r = (
						...
						s = () => this._transitionComplete(t, r, n);
					if (r && a) {
	...
	i
		...
		(i.default.fn.tab.noConflict = () => (
			(i.default.fn.tab = fn), gn._jQueryInterface
		));
	var _n = "bs.toast",
		...
		Sn = (() => {
			...
			return (
				(e.show = function () {
					var e = i.default.Event("show.bs.toast");
					if ((i.default(this._element).trigger(e), !e.isDefaultPrevented())) {
						this._clearTimeout(),
						...
						var n = () => {
							this._element.classList.remove(En),
								...
								i.default(this._element).trigger("shown.bs.toast"),
				...
				(e._setListeners = function () {
					i.default(this._element).on(wn, '[data-dismiss="toast"]', () =>
						this.hide(),
					);
				}),
				(e._close = function () {
					var e = () => {
						this._element.classList.add(bn),
							i.default(this._element).trigger("hidden.bs.toast");
					};
	...
	(i.default.fn.toast = Sn._jQueryInterface),
		...
		(i.default.fn.toast.noConflict = () => (
			(i.default.fn.toast = vn), Sn._jQueryInterface
		)),
		(t.Alert = c),
		(t.Button = b),
		(t.Carousel = O),
