...
!((t, e) => {
			...
			(r =
				...
				function (t) {
					for (var e = 1; e < arguments.length; e++) {
						var n = arguments[e];
						for (var i in n) Object.hasOwn(n, i) && (t[i] = n[i]);
					}
					return t;
				}),
	...
	function u(t, e) {
		return (
			(u = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t))), u(t, e)
		);
	}
	var f = "transitionend";
	var d = {
		...
		supportsTransitionEnd: () => Boolean(f),
	...
	d.jQueryDetection(),
		(o.default.fn.emulateTransitionEnd = function (t) {
			var n = !1;
			return (
				o.default(this).one(d.TRANSITION_END, () => {
					n = !0;
				}),
				setTimeout(() => {
					n || d.triggerTransitionEnd(this);
				}, t),
				this
			);
		}),
			...
			return (
				...
				(e._removeElement = function (t) {
					if (
						...
						o.default(t)
							.one(d.TRANSITION_END, (n) => this._destroyElement(t, n))
				...
				l(t, null, [{ key: "VERSION", get: () => "4.6.1" }]),
				t
			);
		})();
	o
		...
		(o.default.fn.alert.noConflict = () => (
			(o.default.fn.alert = h), g._jQueryInterface
		));
	var m = "bs.button",
	...
	o
		.default(document)
		.on("click.bs.button.data-api", v, (t) => {
			var e = t.target,
				n = e;
			if (
		...
		.on("focus.bs.button.data-api blur.bs.button.data-api", v, (t) => {
			var e = o.default(t.target).closest(b)[0];
			o.default(e).toggleClass("focus", /^focus(in)?$/.test(t.type));
		}),
		o.default(window).on("load.bs.button.data-api", () => {
			for (
				var t = [].slice.call(
		...
		(o.default.fn.button.noConflict = () => (
			(o.default.fn.button = p), E._jQueryInterface
		));
	var T = "carousel",
		w = "bs.carousel",
		C = o.default.fn[T],
			...
			return (
				...
				(e.to = function (t) {
					...
					if (!(t > this._items.length - 1 || t < 0))
						if (this._isSliding)
							o.default(this._element).one(A, () => this.to(t));
						else {
				...
				(e._getConfig = (t) => (
					(t = r({}, k, t)), d.typeCheckConfig(T, t, O), t
				)),
				...
				(e._addEventListeners = function () {
					this._config.keyboard &&
						o
							...
							.on("keydown.bs.carousel", (e) => this._keydown(e)),
						"hover" === this._config.pause &&
							o
								.default(this._element)
								.on("mouseenter.bs.carousel", (e) => this.pause(e))
								.on("mouseleave.bs.carousel", (e) => this.cycle(e)),
				...
				(e._addTouchEventListeners = function () {
					if (this._touchSupported) {
						...
						o
							...
							.on("dragstart.bs.carousel", (t) => t.preventDefault()),
							this._pointerEvent
								? (o
										.default(this._element)
										.on("pointerdown.bs.carousel", (t) => e(t)),
									o
										.default(this._element)
										.on("pointerup.bs.carousel", (t) => n(t)),
									this._element.classList.add("pointer-event"))
								: (o
										.default(this._element)
										.on("touchstart.bs.carousel", (t) => e(t)),
									o.default(this._element).on("touchmove.bs.carousel", (e) =>
										((e) => {
											this.touchDeltaX =
							...
							o.default(l)
								.one(d.TRANSITION_END, () => {
									o
										...
										(this._isSliding = !1),
										setTimeout(() => o.default(this._element).trigger(h), 0);
								})
	...
	o
		...
		o.default(window).on("load.bs.carousel.data-api", () => {
			for (
				var t = [].slice.call(
		...
		(o.default.fn[T].noConflict = () => (
			(o.default.fn[T] = C), P._jQueryInterface
		));
	var L = "collapse",
		R = "bs.collapse",
		x = o.default.fn[L],
		...
		V = (() => {
			...
			return (
							...
							o
								...
								.one(d.TRANSITION_END, () => {
									o
										...
										o.default(this._element).trigger("shown.bs.collapse");
								})
				...
				(e._getParent = function () {
					...
					return (
						o.default(a).each((e, i) => {
							this._addAriaAndCollapsedClass(t._getTargetFromElement(i), [i]);
						}),
						e
					);
				}),
				(e._addAriaAndCollapsedClass = (t, e) => {
					var n = o.default(t).hasClass(q);
					e.length && o.default(e).toggleClass(B, !n).attr("aria-expanded", n);
				}),
				(t._getTargetFromElement = (t) => {
					var e = d.getSelectorFromElement(t);
	...
	o.default(document).on("click.bs.collapse.data-api", U, function (t) {
		...
		(o.default.fn[L].noConflict = () => (
			(o.default.fn[L] = x), V._jQueryInterface
		));
	var z = "dropdown",
		K = "bs.dropdown",
		X = o.default.fn[z],
		...
		lt = (() => {
			...
			return (
				...
				(e._addEventListeners = function () {
					o.default(this._element).on("click.bs.dropdown", (e) => {
					...
					if (
						...
						if (i || 27 !== e.which) {
							...
							var a = [].slice
								...
								.filter((t) => o.default(t).is(":visible"));
							if (0 !== a.length) {
	...
	o
		...
		.on(et, ".dropdown form", (t) => {
			t.stopPropagation();
		}),
		(o.default.fn[z] = lt._jQueryInterface),
		(o.default.fn[z].Constructor = lt),
		(o.default.fn[z].noConflict = () => (
			(o.default.fn[z] = X), lt._jQueryInterface
		));
	var rt = "bs.modal",
		...
		Ct = (() => {
			...
			return (
					...
					if (!this._isShown && !this._isTransitioning) {
						...
						o.default(this._element).trigger(n),
							n.isDefaultPrevented() ||
								...
								o
									.default(this._element)
									.on(vt, '[data-dismiss="modal"]', (t) => this.hide(t)),
								o.default(this._dialog).on(bt, () => {
									o.default(this._element).one(
										"mouseup.dismiss.bs.modal",
										(t) => {
											o.default(t.target).is(this._element) &&
					...
					if (
						...
						if (
							...
							if (
								...
								o.default(this._element)
									.one(d.TRANSITION_END, (t) => this._hideModal(t))
				...
				(e._showElement = function (t) {
					var n = o.default(this._element).hasClass(dt),
					...
					o.default(document)
						...
						.on(pt, (e) => {
							document !== e.target &&
								...
								0 === o.default(this._element).has(e.target).length &&
								this._element.focus();
						});
				}),
				(e._setEscapeEvent = function () {
					this._isShown
						? o.default(this._element).on(yt, (e) => {
								this._config.keyboard && 27 === e.which
				...
				(e._setResizeEvent = function () {
					this._isShown
						? o.default(window).on(_t, (e) => this.handleUpdate(e))
					...
					(this._element.style.display = "none"),
						...
						this._showBackdrop(() => {
							o.default(document.body).removeClass(ft),
								...
								o.default(this._element).trigger(gt);
						});
				}),
				...
				(e._showBackdrop = function (t) {
					var n = o.default(this._element).hasClass(dt) ? dt : "";
					if (this._isShown && this._config.backdrop) {
						if (
							...
							o.default(this._element).on(vt, (t) => {
				...
				(e._resetScrollbar = () => {
					...
					o.default(t).each((t, e) => {
						var n = o.default(e).data("padding-right");
						o.default(e).removeData("padding-right"),
							(e.style.paddingRight = n || "");
					});
					var e = [].slice.call(document.querySelectorAll(".sticky-top"));
					o.default(e).each((t, e) => {
	...
	o
		...
		.on("click.bs.modal.data-api", '[data-toggle="modal"]', function (t) {
			...
			var s = o.default(e).one(mt, (t) => {
				t.isDefaultPrevented() ||
					s.one(gt, () => {
						o.default(this).is(":visible") && this.focus();
					});
			});
		...
		(o.default.fn.modal.noConflict = () => (
			(o.default.fn.modal = ut), Ct._jQueryInterface
		));
	var St = [
			"background",
			"cite",
	...
	var It = "tooltip",
		...
		Wt = (() => {
			...
			return (
				...
				(e.show = function () {
					...
					if (this.isWithContent() && this._isEnabled) {
						...
						var c = () => {
							...
							(this._hoverState = null),
								o.default(this.element).trigger(this.constructor.Event.SHOWN),
								e === qt && this._leave(null, this);
						};
					...
					var n = this.getTipElement(),
						...
						a = () => {
							this._hoverState !== xt &&
								...
								o.default(this.element).trigger(this.constructor.Event.HIDDEN),
				...
				(e._getAttachment = (t) => Bt[t.toUpperCase()]),
				(e._setListeners = function () {
					this.config.trigger.split(" ").forEach((e) => {
						if ("click" === e)
							o.default(this.element).on(
				...
				l(t, null, [
					...
					{ key: "DATA_KEY", get: () => kt },
					{ key: "Event", get: () => Mt },
					{ key: "EVENT_KEY", get: () => ".bs.tooltip" },
					{ key: "DefaultType", get: () => Ut },
				]),
				t
			);
		})();
	(o.default.fn.tooltip = Wt._jQueryInterface),
		...
		(o.default.fn.tooltip.noConflict = () => (
			(o.default.fn.tooltip = Ot), Wt._jQueryInterface
		));
	var Vt = "bs.popover",
		...
		Jt = ((t) => {
			...
			return (
				...
				l(i, null, [
					{ key: "VERSION", get: () => "4.6.1" },
					{ key: "Default", get: () => Xt },
					{ key: "NAME", get: () => "popover" },
					{ key: "DATA_KEY", get: () => Vt },
					{ key: "Event", get: () => $t },
					{ key: "EVENT_KEY", get: () => ".bs.popover" },
					{ key: "DefaultType", get: () => Yt },
				]),
				i
			);
		})(Wt);
	(o.default.fn.popover = Jt._jQueryInterface),
		...
		(o.default.fn.popover.noConflict = () => (
			(o.default.fn.popover = zt), Jt._jQueryInterface
		));
	var Gt = "scrollspy",
		Zt = "bs.scrollspy",
		te = o.default.fn[Gt],
		...
		se = (() => {
			function t(t, e) {
				(this._element = t),
					...
					o
						...
						.on("scroll.bs.scrollspy", (t) => this._process(t)),
					this.refresh(),
					this._process();
			}
			var e = t.prototype;
			return (
				...
				(e._clear = function () {
					[].slice
						.call(document.querySelectorAll(this._selector))
						.filter((t) => t.classList.contains(ee))
						.forEach((t) => t.classList.remove(ee));
				}),
				(t._jQueryInterface = function (e) {
					return this.each(function () {
	...
	o.default(window).on("load.bs.scrollspy.data-api", () => {
		for (
		...
		(o.default.fn[Gt].noConflict = () => (
			(o.default.fn[Gt] = te), se._jQueryInterface
		));
	var le = "bs.tab",
		re = o.default.fn.tab,
		ue = "active",
			...
			return (
					...
					if (
						...
						if (
							...
							var u = () => {
								...
								o.default(n).trigger(e), o.default(this._element).trigger(i);
							};
				...
				(e._activate = function (t, e, n) {
					var a = (
						...
						l = () => this._transitionComplete(t, a, n);
					if (a && s) {
	...
	o
		...
		(o.default.fn.tab.noConflict = () => (
			(o.default.fn.tab = re), ge._jQueryInterface
		));
	var me = "bs.toast",
		...
		we = (() => {
			...
			return (
				(e.show = function () {
					var e = o.default.Event("show.bs.toast");
					if ((o.default(this._element).trigger(e), !e.isDefaultPrevented())) {
						this._clearTimeout(),
						...
						var n = () => {
							this._element.classList.remove(ye),
								...
								o.default(this._element).trigger("shown.bs.toast"),
				...
				(e._setListeners = function () {
					o.default(this._element).on(be, '[data-dismiss="toast"]', () =>
						this.hide(),
					);
				}),
				(e._close = function () {
					var e = () => {
						this._element.classList.add(_e),
							o.default(this._element).trigger("hidden.bs.toast");
					};
	...
	(o.default.fn.toast = we._jQueryInterface),
		...
		(o.default.fn.toast.noConflict = () => (
			(o.default.fn.toast = pe), we._jQueryInterface
		)),
		(t.Alert = g),
		(t.Button = E),
		(t.Carousel = P),
