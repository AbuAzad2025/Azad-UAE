...
!((t, e) => {
	...
	function x(t, e, i) {
		...
		const s = e[t],
			o = i[t];
		n(s) && n(o) ? b(s, o) : Object.hasOwn(e, t) || (e[t] = f(o));
	}
	...
	function Ft(t) {
		...
		return (
			(i =
				"hwb" === e[1]
					? ((t, e, i) => Rt(Lt, t, e, i))(n, o, a)
					: "hsv" === e[1]
						? ((t, e, i) => Rt(Tt, t, e, i))(n, o, a)
						: It(n, o, a)),
	...
	const Ht = (t) =>
		...
		$t = (t) => (t <= 0.04045 ? t / 12.92 : ((t + 0.055) / 1.055) ** 2.4);
	function Yt(t, e, i) {
		if (t) {
			let s = Et(t);
	...
	const ti = (t) => 0 === t || 1 === t,
		ei = (t, e, i) => -(2 ** (10 * (t -= 1))) * Math.sin(((t - e) * O) / i),
		ii = (t, e, i) => 2 ** (-10 * t) * Math.sin(((t - e) * O) / i) + 1,
		si = {
			linear: (t) => t,
			easeInQuad: (t) => t * t,
			easeOutQuad: (t) => -t * (t - 2),
	...
	class on {
		constructor(t) {
			(this._config = ((t) => (((t = t || {}).data = Qs(t.data)), Js(t), t))(
				t,
			)),
			...
			if (
				...
				(d =
					((t, e, i) =>
						0 !== t
							? z(t)
							: (e.isHorizontal() ? 1 : -1) * (e.min >= i ? 1 : -1))(d, e, a) *
					o),
					u === a && (m -= d / 2);
			...
			const t = this.options,
				e = ((t, e) => {
					const i = Math.floor(I(e.max)),
						s = Math.ceil(e.max / 10 ** i),
						n = [];
					let o = a(t.min, 10 ** Math.floor(I(e.min))),
						r = Math.floor(I(o)),
						l = Math.floor(o / 10 ** r),
						h = r < 0 ? 10 ** Math.abs(r) : 1;
					do {
						n.push({ value: o, major: na(o) }),
							++l,
							10 === l && ((l = 1), ++r, (h = r >= 0 ? 1 : h)),
							(o = Math.round(l * 10 ** r * h) / h);
					} while (r < i || (r === i && l < s));
					const c = a(t.max, o);
	...
	class ga extends ia {
		...
		getPointLabelContext(t) {
			...
			if (t >= 0 && t < e.length) {
				const i = e[t];
				return ((t, e, i) => _i(t, { label: i, index: e, type: "pointLabel" }))(
					this.getContext(),
					t,
					i,
				);
