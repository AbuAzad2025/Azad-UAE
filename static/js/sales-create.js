...
$(document).ready(function() {
  ...
  $('#generate_serial_btn').on('click', function() {
    const productId = $('#product_id').val() || '';
  ...
  $('#print_serials_btn').on('click', function() {
    const serials = [];
    ...
    _printDoc.write('<style>body{font-family:Arial;padding:20px}.serial{border:1px solid #000;padding:8px;margin:4px 0;text-align:center;font-size:18px;letter-spacing:2px}</style>');
  ...
  $('#save_serials_btn').on('click', function() {
