...
interface JQuery {
  ...
  hover(handlerIn: (event: JQueryEventObject) => void, handlerOut?: (event: JQueryEventObject) => void): this;
  focus(): this;
  select(): this;
  blur(): this;
...
interface JQueryStatic {
  fn: Record<string, any> & { DataTable: JQueryDataTable; dataTable: any; select2: any; datepicker: any; tooltip: any; modal: any; alert: any; tab: any };
  ...
  extend(deep: boolean | Record<string, any>, target: Record<string, any>, ...sources: Record<string, any>[]): Record<string, any>;
...
interface JQueryXHR {
  ...
  then(doneCallback: (data: any, textStatus: string, jqXHR: JQueryXHR) => void, failCallback?: (jqXHR: JQueryXHR, textStatus: string, errorThrown: string) => void): this;
  status: number;
  responseJSON?: any;
  responseText?: string;
}
...
interface Window {
  ...
  BarcodeScanner?: new (options: { onScan: (code: string) => void; minLength?: number }) => { start(): void };
  notify?: {
