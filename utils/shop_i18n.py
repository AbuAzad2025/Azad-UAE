...
STRINGS = {
    ...
    "already_submitted": {
        "ar": "تم استلام طلبك مسبقاً — لن يتم إنشاء طلب مكرر.",
        "en": "Your order was already received — no duplicate was created.",
    },
    "order_number_example": {"ar": "مثال: S-2026-000123", "en": "e.g. S-2026-000123"},
    "share_facebook": {"ar": "مشاركة على فيسبوك", "en": "Share on Facebook"},
    "share_twitter": {"ar": "مشاركة على تويتر", "en": "Share on Twitter"},
    "share_whatsapp": {"ar": "مشاركة عبر واتساب", "en": "Share on WhatsApp"},
    "breadcrumb": {"ar": "مسار التنقل", "en": "Breadcrumb"},
    "pagination": {"ar": "ترقيم الصفحات", "en": "Pagination"},
    "seo": {"ar": "تحسين محركات البحث", "en": "SEO"},
    "meta_title_ar": {"ar": "عنوان الميتا (عربي)", "en": "Meta Title (AR)"},
    "meta_title_en": {"ar": "عنوان الميتا (إنجليزي)", "en": "Meta Title (EN)"},
    "meta_description_ar": {"ar": "وصف الميتا (عربي)", "en": "Meta Description (AR)"},
    "meta_description_en": {"ar": "وصف الميتا (إنجليزي)", "en": "Meta Description (EN)"},
    "meta_keywords": {"ar": "الكلمات المفتاحية", "en": "Meta Keywords"},
    "sitemap": {"ar": "خريطة الموقع", "en": "Sitemap"},
    "subdomain": {"ar": "النطاق الفرعي", "en": "Subdomain"},
    "custom_domain": {"ar": "النطاق المخصص", "en": "Custom Domain"},
    "in_english": {"ar": "بالإنجليزية", "en": "In English"},
    ...
    "quantity_for": {"ar": "الكمية لـ", "en": "Quantity for"},
    "excellent": {"ar": "ممتاز", "en": "Excellent"},
    "locked_by_platform": {"ar": "مقفل من المنصة", "en": "Locked by platform"},
    "units_in_warehouse": {"ar": "وحدة في المستودع", "en": "units in warehouse"},
    "min_for_order": {"ar": "الحد الأدنى للطلب", "en": "Minimum for order"},
    "usage_limit": {"ar": "حد الاستخدام", "en": "Usage limit"},
    "code_label": {"ar": "الرمز", "en": "Code"},
    "catalog_linked_online": {"ar": "مرتبط بالمتجر الإلكتروني فقط", "en": "Linked online only"},
}
