...
STRINGS = {
    ...
    'guest_browse': {'ar': 'تصفّح كزائر — يمكنك إضافة منتجات للسلة', 'en': 'Browsing as guest — you can add items to cart'},
    ...
    'review_submitted': {'ar': 'تم إرسال تقييمك وسيظهر بعد المراجعة', 'en': 'Your review has been submitted and will appear after review'},
    ...
    'whatsapp_email_notify': {'ar': 'ستصلك رسالة تأكيد الطلب عبر واتساب/بريد إلكتروني', 'en': 'You will receive order confirmation via WhatsApp/Email'},
    'print_invoice': {'ar': 'طباعة الفاتورة', 'en': 'Print Invoice'},
    'invoice': {'ar': 'فاتورة', 'en': 'Invoice'},
    'variant': {'ar': 'النوع', 'en': 'Variant'},
    'out_of_stock_notify': {'ar': 'نفد من المخزون — أشعرني عند التوفر', 'en': 'Out of stock — notify me when available'},
    'notify_me': {'ar': 'أشعرني', 'en': 'Notify me'},
    'alert_exists': {'ar': 'أنت مشترك بالفعل في التنبيه لهذا المنتج', 'en': 'You are already subscribed for this product'},
    'alert_created': {'ar': 'تم التسجيل — سنخبرك عند توفر المنتج', 'en': 'Subscribed — we\'ll notify you when available'},
