...
class TestTenantIsolation:
    def test_cross_tenant_access_is_blocked(self, app, db_session):
        ...
        tenant_a = Tenant(
            name=f'TenantA {ta_id}', name_ar=f'TenantA {ta_id}',
            slug=f'tenant-a-{ta_id}', default_currency='AED', base_currency='AED',
        )
        ...
        user_a = User(
            tenant_id=tenant_a.id, username=f'user_a_{ta_id}',
            email=f'a_{ta_id}@test.com', is_active=True,
            password_hash='fakehash', branch_id=branch_a.id,
            role_id=role_a.id,
        )
        ...
        tenant_b = Tenant(
            name=f'TenantB {tb_id}', name_ar=f'TenantB {tb_id}',
            slug=f'tenant-b-{tb_id}', default_currency='AED', base_currency='AED',
        )
        ...
        user_b = User(
            tenant_id=tenant_b.id, username=f'user_b_{tb_id}',
            email=f'b_{tb_id}@test.com', is_active=True,
            password_hash='fakehash', branch_id=branch_b.id,
            role_id=role_b.id,
        )
