...
class TestFullBusinessCycleTenantScoping:
    ...
    def _create_sale(self, data, user):
        ...
        product = Product(
            tenant_id=tid, name=data['product_name'],
            sku=f'SKU_{tid}', cost=data['price'],
    ...
    def test_cross_tenant_isolation(self, tenant_a_data, tenant_b_data):
        ...
        rec_a = self._create_sale(tenant_a_data, user=None)
