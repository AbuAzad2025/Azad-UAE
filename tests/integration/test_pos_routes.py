...
class TestPOSSession:
    ...
    def test_pos_sale_on_customer_credit(self, app, db_session, client):
        ...
        customer = Customer(
            name=f"CreditCust {tid}",
            phone=f"050{tid[:4]}1111",
            tenant_id=tenant.id,
