...
class TestCeleryMaintenanceTasks:
    ...
    def test_auto_backup_database(self, mocker, mock_app_context):
        mocker.patch(
            "services.backup_service.BackupService.auto_backup_daily",
            return_value={"id": 1},
        )
    ...
    def test_update_exchange_rates(self, mocker, mock_app_context):
        ...
        mocker.patch.dict(
            "sys.modules",
            {"services.currency_service": MagicMock(CurrencyService=fake_cs)},
        )
...
class TestAbandonedCartReminders:
    ...
    def test_second_reminder_increments_count(self, mocker):
        ...
        mocker.patch(
            ...
            return_value=MagicMock(email="s@t.com"),
        )
        mocker.patch("extensions.db.session")
    ...
    def test_failed_commit_rolls_back(self, mocker):
        ...
        mocker.patch(
            "services.store_service.StoreService.get_tenant_store",
            return_value=MagicMock(email="x@y.com"),
        )
