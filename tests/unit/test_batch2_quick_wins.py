...
class TestModelReprQuickWins:
    @pytest.mark.parametrize(
        "module_path,cls_name,attrs,expected",
        [
            ("models.branch", "Branch", {"name": "HQ", "code": "MAIN"}, "HQ"),
            (
                "models.product_serial",
                "ProductSerial",
                {"serial_number": "SN1", "status": "available"},
                "SN1",
            ),
            (
                "models.error_audit_log",
                "ErrorAuditLog",
                {
                    "category": "API",
                    "level": "ERROR",
                    "message": "timeout on endpoint",
                },
                "API",
            ),
            (
                "models.azad_platform_fee",
                "AzadPlatformFee",
                {
                    "sale_id": 1,
                    "fee_amount_aed": Decimal("5"),
                },
                "sale=1",
            ),
            (
                "models.azad_subscription_fee",
                "AzadSubscriptionFee",
                {
                    "tenant_id": 1,
                    "fee_type": "monthly",
                    "amount_aed": Decimal("99"),
                },
                "tenant=1",
            ),
            (
                "models.product_cost_history",
                "ProductCostHistory",
                {
                    "product_id": 2,
                    "movement_type": "in",
            ...
            (
                "models.partner",
                "Partner",
                {"name": "Sami", "share_percentage": Decimal("25")},
                "Sami",
            ),
            ...
            (
                "models.projects",
                "Timesheet",
                {"date": "2026-06-01", "hours": Decimal("4")},
                "4h",
            ),
            ...
            (
                "models.campaign",
                "Campaign",
                {"name": "Ramadan", "campaign_type": "percent"},
                "Ramadan",
            ),
            (
                "models.campaign",
