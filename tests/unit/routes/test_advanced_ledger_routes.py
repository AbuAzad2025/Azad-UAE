...
def _advanced_ledger_patches(**kwargs):
    ...
    with ExitStack() as stack:
        ...
        tax_q = stack.enter_context(patch("models.advanced_accounting.CustomsTax.query"))
        cat_q = stack.enter_context(patch("models.expense.ExpenseCategory.query"))
        exp_q = stack.enter_context(patch("models.advanced_accounting.AdvancedExpense.query"))
        stack.enter_context(patch("models.Cheque.query", cheque_q))
