...
class TestApiEndpoints:
    ...
    def test_payment_fields(self, api_client):
        ...
        assert resp.status_code == 200
        assert resp.get_json()["data"]["en_title"] == "Cheque Payment"
    ...
    def test_industry_fields(self, api_client, mocker):
        ...
        assert resp.status_code == 200
        assert resp.get_json()["data"]["fields"][0]["field_code"] == "vat"
    ...
    def test_search_customers(self, api_client, mocker):
        ...
        assert resp.status_code == 200
        assert resp.get_json()["data"]["results"][0]["balance_aed"] == 12.0
