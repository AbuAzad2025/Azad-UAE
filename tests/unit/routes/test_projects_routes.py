...
def _projects_patches(**kwargs):
    ...
    with ExitStack() as stack:
        ...
        stack.enter_context(
            patch(
                "routes.projects.ProjectService.list_projects",
        ...
        stack.enter_context(patch("routes.projects.ProjectService.stages_for_project", return_value=stages))
        stack.enter_context(patch("routes.projects.ProjectService.tasks_for_project", return_value=tasks))
        stack.enter_context(patch("routes.projects.ProjectService.members_for_project", return_value=members))
        stack.enter_context(patch("routes.projects.ProjectService.active_users_for_tenant", return_value=users))
...
class TestProjectCreate:
    ...
    def test_create_post_error(self, projects_client):
        with (
            _projects_patches(),
            patch(
                "routes.projects.ProjectService.create_project",
...
class TestProjectDetail:
    ...
    def test_detail_not_found_redirects(self, projects_client):
        with (
            _projects_patches(),
            patch(
                "routes.projects.ProjectService.get_project",
    ...
    def test_edit_post_error(self, projects_client):
        with (
            _projects_patches(),
            patch(
                "routes.projects.ProjectService.update_project",
...
class TestProjectTasks:
    ...
    def test_add_task_error(self, projects_client):
        with (
            _projects_patches(),
            patch(
                "routes.projects.ProjectService.create_task",
                side_effect=ValueError("no name"),
            ),
        ):
    ...
    def test_api_move_task_error(self, projects_client):
        with (
            _projects_patches(),
            patch(
                "routes.projects.ProjectService.move_task",
...
class TestGanttAndMembers:
    ...
    def test_gantt_not_found(self, projects_client):
        with (
            _projects_patches(),
            patch(
                "routes.projects.ProjectService.get_gantt_data",
                side_effect=ValueError("gone"),
            ),
        ):
    ...
    def test_add_member_error(self, projects_client):
        with (
            _projects_patches(),
            patch(
                "routes.projects.ProjectService.add_member",
