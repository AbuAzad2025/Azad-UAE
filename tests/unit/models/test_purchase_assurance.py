...
class TestPurchaseLine:
    ...
    def test_landed_unit_cost_zero_qty(self):
        line = PurchaseLine(
            tenant_id=1, purchase_id=1, product_id=1,
            quantity=Decimal('0'), unit_cost=Decimal('10'), line_total=Decimal('0'),
        )
    ...
    def test_landed_unit_cost_with_landed(self):
        line = PurchaseLine(
            tenant_id=1, purchase_id=1, product_id=1,
            quantity=Decimal('2'), unit_cost=Decimal('10'), line_total=Decimal('20'),
    ...
    def test_inventory_unit_cost_vat_exclusive(self):
        ...
        line = PurchaseLine(
            tenant_id=1, purchase_id=1, product_id=1,
            quantity=Decimal('2'), unit_cost=Decimal('10'), discount_percent=Decimal('0'),
            line_total=Decimal('20'),
        )
    ...
    def test_inventory_unit_cost_vat_inclusive(self):
        ...
        line = PurchaseLine(
            tenant_id=1, purchase_id=1, product_id=1,
            quantity=Decimal('2'), unit_cost=Decimal('10.50'), discount_percent=Decimal('0'),
    ...
    def test_landed_inventory_unit_cost(self):
        ...
        line = PurchaseLine(
            tenant_id=1, purchase_id=1, product_id=1,
            quantity=Decimal('2'), unit_cost=Decimal('10'), discount_percent=Decimal('0'),
            line_total=Decimal('20'), landed_cost=Decimal('4'),
        )
        line.purchase = purchase
