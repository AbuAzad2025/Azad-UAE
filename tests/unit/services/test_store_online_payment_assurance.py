...
class TestCreatePayment:
    ...
    def test_gateway_failure_raises(self, app, mocker):
        sale = MagicMock(
            id=10, sale_number='S-10', amount_aed=Decimal('100'),
            total_amount=100, currency='AED', checkout_payment_method=None,
        )
        ...
        mocker.patch('services.store_online_payment_service.get_nowpayments_ipn_url', return_value='https://ipn')
    ...
    def test_success_commits_gateway_ref(self, app, mocker):
        sale = MagicMock(
            id=5, sale_number='S-5', amount_aed=Decimal('50'),
            total_amount=50, currency='aed', checkout_payment_method=None,
        )
    ...
    def test_commit_failure_rolls_back(self, app, mocker):
        sale = MagicMock(
            id=6, sale_number='S-6', amount_aed=Decimal('20'),
            total_amount=20, currency='aed', checkout_payment_method='cod',
        )
