...
class TestApAgingBuckets:
    ...
    def test_bucket_boundaries_and_fifo(self, mocker):
        ...
        # FIFO: first 100 fully paid, second 50 paid -> 50 balance in 31-60
        assert row["buckets"]["0-30"] == 0.0
        assert row["buckets"]["31-60"] == 50.0
        assert row["buckets"]["61-90"] == 100.0
        assert row["buckets"]["90+"] == 100.0
