...
class TestMergeCheckoutLines:
    def test_merges_duplicate_product_rows(self):
        lines = [
            ...
            {'product_id': 1, 'quantity': '3', 'discount_percent': 5, 'unit_price': '20'},
        ]
...
class TestProductSearch:
    ...
    def test_exact_barcode_lookup(self, mocker):
        ...
        mocker.patch('utils.pos_helpers.StockService.get_visible_products_query', return_value=base)
...
class TestClosePosSession:
    ...
    def test_close_posts_shortage_gl(self, mocker):
        ...
        mocker.patch('services.gl_tree_builder.GLTreeBuilder._branch_account_code', return_value='1110')
        mocker.patch('services.gl_helpers.get_account', return_value=MagicMock(is_header=False))
        mocker.patch('services.gl_service.GLService.get_account_code_for_concept', side_effect=['1110', '6995'])
    ...
    def test_close_header_cash_account_fallback(self, mocker):
        ...
        mocker.patch('services.gl_service.GLService.get_account_code_for_concept', side_effect=['1110-B', '6995'])
        create_je = mocker.patch('services.gl_service.GLService.create_journal_entry')
