...
def test_get_images_filter(db_session, sample_product):
...
def test_reorder_only_matching_product(db_session, sample_product):
...
def test_delete_image(db_session, sample_product):
