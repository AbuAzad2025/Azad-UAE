...
class TestDatabaseMessages:
    ...
    @pytest.mark.parametrize('entity', ['customer', 'product', 'sale', 'user', 'supplier', 'warehouse', 'cheque', 'ledger', 'unknown'])
...
class TestSuccessMessages:
    @pytest.mark.parametrize('entity', ['customer', 'product', 'sale', 'user', 'payment', 'expense', 'unknown'])
