...
class TestGetNowpaymentsIpnUrl:
    def test_delegates_to_provider(self):
        ...
        with patch('services.payments.nowpayments_provider.NowPaymentsProvider', return_value=provider):
...
class TestResolveNowpaymentsIpnSecret:
    ...
    def test_db_exception_falls_back_to_provider(self):
        ...
        with patch('models.payment_vault.PaymentVault.get_platform_vault', side_effect=RuntimeError('db down')), \
             patch('services.payments.nowpayments_provider.NowPaymentsProvider', return_value=provider):
