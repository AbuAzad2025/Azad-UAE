...
class TestResolveBranding:
    ...
    def test_document_logo_explicit_settings_override(self, mocker):
        ...
        mocker.patch('utils.tenant_branding.resolve_tenant_branding', return_value={'logo_url': 'fallback'})
        mocker.patch('os.path.isfile', return_value=True)
    ...
    def test_document_logo_no_explicit_returns_branding(self, mocker):
        mocker.patch('utils.tenant_branding.resolve_tenant_branding', return_value={'logo_url': 'brand.png'})
    ...
    def test_document_logo_explicit_empty_falls_through(self, mocker):
        ...
        mocker.patch('utils.tenant_branding.resolve_tenant_branding', return_value={'logo_url': 'fallback.png'})
