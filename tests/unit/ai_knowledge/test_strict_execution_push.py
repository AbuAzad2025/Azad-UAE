...
class TestContextEngineIntents:
    def test_enhance_analysis_intent(self):
        ...
        with patch("ai_knowledge.core.context_engine.data_analyzer") as da:
            da.get_financial_ratios.return_value = {
                "success": True,
                "ratios": {"gross_profit_margin": 10, "net_profit_margin": 5},
            }
...
class TestContinuousLearnerPush:
    ...
    def test_evaluate_and_learn_success(self):
        ...
        tests = [
            {
                "question": "sales?",
                "expected_keywords": ["sales", "revenue"],
                "context": {},
            }
        ]
...
class TestMultiAgentSystemPush:
    def test_sales_agent_price_task(self):
        ...
        with patch(
            ...
            return_value={"predicted_price": 99, "confidence": 0.9},
        ):
    ...
    def test_coordinator_delegates_task(self):
        ...
        with patch(
            "services.ai_service.AIService.predict_price_with_neural",
            return_value={"predicted_price": 50, "confidence": 0.8},
        ):
...
class TestConversationManagerPush:
    ...
    def test_memory_save_failure_logged(self):
        ...
        with patch(
            "ai_knowledge.core.memory_system.get_memory_system",
...
class TestContinuousLearnerExtended:
    def test_learn_wikipedia_success(self, tmp_path, monkeypatch):
        ...
        resp.json.return_value = {
            "extract": "Accounting basics",
            "content_urls": {"desktop": {"page": "http://wiki"}},
        }
        with (
            patch.object(learner.session, "get", return_value=resp),
