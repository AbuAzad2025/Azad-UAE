...
from ai_knowledge.learning.external_learning import ExternalLearningSystem, get_external_learning
...
class TestAutoRetraining:
    def test_should_retrain(self):
        with patch('ai_knowledge.learning.auto_retraining.os.path.exists', return_value=False), \
