...
class TestDomainExports:
    ...
    def test_purchases_export_rows(self):
        ...
        purchase = MagicMock(
            id=1, package=pkg, customer_name='Ali', customer_email='a@x.com',
            amount_paid=99.0, payment_method='card', payment_status='completed',
    ...
    def test_donations_anonymous_fallback(self):
        donation = MagicMock(
            id=2, donor_name=None, donor_email=None,
            amount_usd=25, payment_method='paypal', status='completed',
            created_at=None,
        )
        from services.export_service import ExportService
    ...
    def test_cards_export_uses_display_helper(self):
        card = MagicMock(
            id=3, customer_name='Sara', customer_email='s@x.com',
            card_type='visa', amount=50, status='active',
