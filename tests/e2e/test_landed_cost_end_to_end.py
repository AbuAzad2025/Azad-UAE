...
def main():
    ...
    with app.app_context():
        ...
        try:
            ...
            assert pl.landed_cost == total_landed, f"Landed cost allocation mismatch: {pl.landed_cost} != {total_landed}"
            ...
            records = [
                ...
                (ProductCostHistory, {'reference_id': getattr(purchase, 'id', None), 'reference_type': 'Purchase'}),
                (ProductCostHistory, {'reference_id': getattr(sale, 'id', None), 'reference_type': 'Sale'}),
            ]
