...
while i < len(lines):
    ...
    if line.strip() == "$.fn = {};":
        ...
        while i < len(lines):
            ...
            if (
                next_line.strip().startswith("$.fn.")
                or next_line.strip().startswith("$.ajax")
                or next_line.strip().startswith("$.get")
                or next_line.strip().startswith("$.notify")
                or next_line.strip().startswith("$.each")
                or next_line.strip().startswith("$.extend")
            ):
