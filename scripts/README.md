...
- `dev/` — One-off development/audit scripts (not for production)
- `audit/` — Audit report outputs (ignored in production)
- `backup/` — DB backup dumps (ignored in production)
...
Scripts in `dev/` are for local development only.
