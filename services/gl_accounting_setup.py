...
DEFAULT_CONCEPT_RULES: dict[str, ConceptSetupRule] = {
    ...
    "CASH": ConceptSetupRule(
        search_names=("cash", "cashbox", "petty cash", gettext("صندوق"), gettext("نقد")),
        expected_types=("asset",),
        parent_code_hint="1110",
        creation_template={
            "code_suffix": "-B1",
            "name": "Cash",
            "name_ar": gettext("صندوق"),
            "type": "asset",
            "liquidity_kind": "cash",
    ...
    "BANK": ConceptSetupRule(
        search_names=("bank", "checking", "savings", gettext("بنك")),
        expected_types=("asset",),
    ...
    "SALES_RETURNS": ConceptSetupRule(
        search_names=("sales return", "returns", gettext("مردودات مبيعات")),
        expected_types=("revenue",),
        creation_template={
            "code_near": "4110",
            "name": "Sales Returns",
            "name_ar": gettext("مردودات مبيعات"),
            "type": "revenue",
        },
    ),
    "SALES_DISCOUNT": ConceptSetupRule(
        search_names=("discount", "discounts given", gettext("خصم مبيعات")),
        expected_types=("expense", "revenue"),
        creation_template={
            "code_near": "6130",
            "name": "Sales Discount",
            "name_ar": gettext("خصم مبيعات"),
            "type": "expense",
        },
    ),
    "VAT_INPUT": ConceptSetupRule(
        search_names=("vat input", "input vat", gettext("ضريبة مدخلات")),
        expected_types=("asset", "liability"),
        creation_template={
            "code_near": "1170",
            "name": "VAT Input",
            "name_ar": gettext("ضريبة مدخلات"),
            "type": "asset",
        },
    ),
    ...
    "FX_GAIN": ConceptSetupRule(
        search_names=("foreign exchange gain", "fx gain", gettext("أرباح فروقات عملة")),
        expected_types=("revenue",),
        creation_template={
            "code_near": "4400",
            "name": "Foreign Exchange Gain",
            "name_ar": gettext("أرباح فروقات عملة"),
            "type": "revenue",
        },
    ),
    "FX_LOSS": ConceptSetupRule(
        search_names=("foreign exchange loss", "fx loss", gettext("خسائر فروقات عملة")),
        expected_types=("expense",),
        creation_template={
            "code_near": "6900",
            "name": "Foreign Exchange Loss",
            "name_ar": gettext("خسائر فروقات عملة"),
            "type": "expense",
        },
    ),
    ...
    "INVENTORY_ADJUSTMENT_GAIN": ConceptSetupRule(
        search_names=("inventory adjustment gain", gettext("أرباح تسوية مخزون")),
        expected_types=("revenue",),
        creation_template={
            "code_near": "4450",
            "name": "Inventory Adjustment Gain",
            "name_ar": gettext("أرباح تسوية مخزون"),
            "type": "revenue",
        },
    ),
    "INVENTORY_ADJUSTMENT_LOSS": ConceptSetupRule(
        search_names=(
            ...
            gettext("خسائر تسوية مخزون"),
        ),
        expected_types=("expense",),
        creation_template={
            "code_near": "5150",
            "name": "Inventory Adjustment Loss",
            "name_ar": gettext("خسائر تسوية مخزون"),
            "type": "expense",
        },
    ),
    "FREIGHT_IN": ConceptSetupRule(
        search_names=("freight in", "shipping in", gettext("مصاريف شحن وارد")),
        expected_types=("expense",),
        creation_template={
            "code_near": "5120",
            "name": "Freight In",
            "name_ar": gettext("مصاريف شحن وارد"),
            "type": "expense",
        },
    ),
    "CUSTOMS_DUTY": ConceptSetupRule(
        search_names=("customs duty", "customs", "tariff", gettext("رسوم جمركية")),
        expected_types=("expense",),
        creation_template={
            "code_near": "5130",
            "name": "Customs Duty",
            "name_ar": gettext("رسوم جمركية"),
            "type": "expense",
        },
    ),
}
...
DEFAULT_CONCEPT_RULES.update(
    {
        "DEFERRED_CHEQUES_PAYABLE": ConceptSetupRule(
            ...
            creation_template={
                ...
                "name_ar": gettext("شيكات مؤجلة الدفع"),
                "type": "liability",
            },
        ),
        "END_OF_SERVICE_PROVISION": ConceptSetupRule(
            ...
            search_names=(
                "end of service",
                "eos provision",
                gettext("مخصص نهاية خدمة"),
                gettext("تعويض نهاية خدمة"),
            ),
            expected_types=("expense",),
            creation_template={
                "code_near": "6190",
                "name": "End of Service Provision",
                "name_ar": gettext("مصروف مخصص نهاية خدمة"),
                "type": "expense",
            },
        ),
        "LEAVE_ACCRUAL_LIABILITY": ConceptSetupRule(
            ...
            search_names=(
                "leave accrual",
                "vacation accrual",
                gettext("استحقاقات إجازة"),
                gettext("إلتزام إجازات"),
            ),
            expected_types=("liability",),
            creation_template={
                "code_near": "2160",
                "name": "Leave Accrual Liability",
                "name_ar": gettext("إلتزام استحقاقات إجازة"),
                "type": "liability",
            },
        ),
        "PARTNER_CURRENT_ACCOUNT": ConceptSetupRule(
            legacy_code="3350",
            search_names=("partner current", "partners current", gettext("جاري الشركاء")),
            expected_types=("equity", "liability", "asset"),
            creation_template={
                "code_near": "3350",
                "name": "Partner Current Account",
                "name_ar": gettext("جاري الشركاء"),
                "type": "equity",
            },
        ),
        "MERCHANT_CURRENT_ACCOUNT": ConceptSetupRule(
            legacy_code="2115",
            search_names=("merchant current", "merchant payable", gettext("ذمم التجار")),
            expected_types=("liability", "asset"),
            creation_template={
                "code_near": "2115",
                "name": "Merchant Current Account",
                "name_ar": gettext("ذمم التجار"),
                "type": "liability",
            },
        ),
        "SHIPPING_REVENUE": ConceptSetupRule(
            legacy_code="4300",
            search_names=("shipping revenue", "delivery revenue", gettext("إيرادات الشحن")),
            expected_types=("revenue",),
            creation_template={
                "code_near": "4300",
                "name": "Shipping Revenue",
                "name_ar": gettext("إيرادات شحن"),
                "type": "revenue",
            },
        ),
        "MISC_EXPENSE": ConceptSetupRule(
            legacy_code="6990",
            search_names=("miscellaneous expense", "misc expense", gettext("مصاريف متنوعة")),
            expected_types=("expense",),
            creation_template={
                "code_near": "6990",
                "name": "Miscellaneous Expense",
                "name_ar": gettext("مصاريف متنوعة"),
                "type": "expense",
            },
        ),
        "COMMISSION_EXPENSE": ConceptSetupRule(
            legacy_code="6150",
            search_names=("commission expense", "partner commission", gettext("مصروف عمولات")),
            expected_types=("expense",),
            creation_template={
                "code_near": "6150",
                "name": "Commission Expense",
                "name_ar": gettext("مصروف عمولات"),
                "type": "expense",
            },
        ),
        "EMPLOYEE_ADVANCES": ConceptSetupRule(
            legacy_code="1160",
            search_names=("employee advances", "salary advances", gettext("سلف الموظفين")),
            expected_types=("asset",),
            creation_template={
                "code_near": "1160",
                "name": "Employee Advances",
                "name_ar": gettext("سلف الموظفين"),
                "type": "asset",
            },
        ),
        "PAYROLL_EXPENSE": ConceptSetupRule(
            legacy_code="6100",
            search_names=("salary", "payroll", "wages", gettext("رواتب")),
            expected_types=("expense",),
            creation_template={
                "code_near": "6100",
                "name": "Payroll Expense",
                "name_ar": gettext("رواتب وأجور"),
                "type": "expense",
            },
        ),
        "PAYROLL_PAYABLE": ConceptSetupRule(
            legacy_code="2141",
            search_names=("salary payable", "payroll payable", gettext("رواتب مستحقة")),
            expected_types=("liability",),
            creation_template={
                "code_near": "2141",
                "name": "Payroll Payable",
                "name_ar": gettext("رواتب مستحقة"),
                "type": "liability",
            },
        ),
        "END_OF_SERVICE_LIABILITY": ConceptSetupRule(
            ...
            creation_template={
                ...
                "name_ar": gettext("مخصص نهاية الخدمة للموظفين"),
                "type": "liability",
            },
        ),
        ...
        "BANK_FEES": ConceptSetupRule(
            legacy_code="6950",
            search_names=("bank charges", "bank fees", gettext("مصاريف بنكية")),
            expected_types=("expense",),
            creation_template={
                "code_near": "6950",
                "name": "Bank Fees",
                "name_ar": gettext("مصاريف بنكية"),
                "type": "expense",
            },
        ),
        "BANK_INTEREST_INCOME": ConceptSetupRule(
            ...
            creation_template={
                ...
                "name_ar": gettext("إيرادات فوائد بنكية"),
                "type": "revenue",
            },
        ),
        "DONATION_REVENUE": ConceptSetupRule(
            legacy_code="4200",
            search_names=("donation revenue", "service revenue", gettext("إيرادات الخدمات")),
            expected_types=("revenue",),
            creation_template={
                "code_near": "4200",
                "name": "Donation Revenue",
                "name_ar": gettext("إيرادات تبرعات"),
                "type": "revenue",
            },
        ),
        "FIXED_ASSET_ASSET": ConceptSetupRule(
            legacy_code="1240",
            search_names=("fixed asset", "equipment", gettext("أصول ثابتة"), gettext("معدات")),
            expected_types=("asset",),
            parent_code_hint="1200",
            creation_template={
                "code_near": "1240",
                "name": "Fixed Asset",
                "name_ar": gettext("أصول ثابتة"),
                "type": "asset",
            },
        ),
        "DEPRECIATION_EXPENSE": ConceptSetupRule(
            legacy_code="6180",
            search_names=("depreciation expense", gettext("استهلاك")),
            expected_types=("expense",),
            creation_template={
                "code_near": "6180",
                "name": "Depreciation Expense",
                "name_ar": gettext("مصروف استهلاك"),
                "type": "expense",
            },
        ),
        "ACCUMULATED_DEPRECIATION": ConceptSetupRule(
            legacy_code="1290",
            search_names=("accumulated depreciation", gettext("مجمع الاستهلاك")),
            expected_types=("asset",),
            parent_code_hint="1200",
            creation_template={
                "code_near": "1290",
                "name": "Accumulated Depreciation",
                "name_ar": gettext("مجمع الاستهلاك"),
                "type": "asset",
            },
        ),
        "FIXED_ASSET_GAIN": ConceptSetupRule(
            ...
            creation_template={
                ...
                "name_ar": gettext("أرباح بيع أصول ثابتة"),
                "type": "revenue",
            },
        ),
        "FIXED_ASSET_LOSS": ConceptSetupRule(
            ...
            creation_template={
                ...
                "name_ar": gettext("خسائر بيع أصول ثابتة"),
                "type": "expense",
            },
        ),
    }
