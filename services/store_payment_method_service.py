...
DEFAULT_METHODS = (
    {
        "code": "cod",
        "name_ar": gettext("الدفع عند الاستلام"),
        "name_en": "Cash on Delivery",
        "description_ar": gettext("ادفع نقداً عند استلام طلبك."),
    ...
    {
        "code": "bank_transfer",
        "name_ar": gettext("تحويل بنكي"),
        "name_en": "Bank Transfer",
        "description_ar": gettext("حوّل المبلغ ثم أرفق رقم المرجع في الملاحظات."),
    ...
    {
        "code": "card",
        "name_ar": gettext("بطاقة (عند الاستلام أو عبر الرابط)"),
        "name_en": "Card (on delivery or link)",
        "description_ar": gettext("الدفع ببطاقة عند التسليم أو حسب تعليمات المتجر."),
    ...
    {
        "code": "e_wallet",
        "name_ar": gettext("محفظة إلكترونية"),
        "name_en": "E-Wallet",
        "description_ar": gettext("Apple Pay، Google Pay، أو محافظ أخرى حسب إعداد المنصة."),
    ...
    {
        "code": "online_pay",
        "name_ar": gettext("دفع إلكتروني (عملات رقمية)"),
        "name_en": "Online Pay (Crypto)",
        "description_ar": gettext("ادفع عبر بوابة NOWPayments — يُفعّل عند إعداد الخزينة."),
...
class StorePaymentMethodService:
    ...
    def create_method(data: dict) -> StorePaymentMethod:
        ...
        if len(name_ar) < 2 and len(name_en) < 2:
            raise ValueError(gettext("الاسم بالعربية أو الإنجليزية مطلوب."))
