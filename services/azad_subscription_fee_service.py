...
class AzadSubscriptionFeeService:
    ...
    def create_subscription_fee(
        ...
        *,
        ...
        current_app.logger.info('Subscription fee accrued: tenant=%s type=%s amount=%s', tenant_id, fee_type, amount)
        return fee
    ...
    def record_payment(
        ...
        *,
        ...
        current_app.logger.info('Subscription fee paid: fee_id=%s amount=%s method=%s', fee_id, amount, payment_method)
        return fee
