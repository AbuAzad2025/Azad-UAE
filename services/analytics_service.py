...
class AnalyticsService:
    ...
    def get_customer_insights(tenant_id, branch_id=None):
        ...
        if branch_id is not None:
            customers_query = (
                customers_query.join(models.Sale, models.Customer.id == models.Sale.customer_id)
    ...
    def get_forecasting_data(tenant_id, branch_id=None):
        ...
        forecast = {"next_month": 0, "next_3_months": 0, "confidence": gettext("غير متوفرة")}
    ...
    def get_customer_behavior(tenant_id=None):
        ...
        return {
            ...
            "avg_purchases_per_customer": (
                round(sum(c["purchases"] for c in customers.values()) / len(customers), 2) if customers else 0
            ),
