    ...
    if request.method == "POST":
        try:
            ...
            cheque = ChequeService.create_cheque(
                ...
                cheque_bank_number=request.form.get("cheque_bank_number") or "",
                cheque_type=cheque_type,
                bank_name=request.form.get("bank_name") or "",
                bank_branch=request.form.get("bank_branch") or "",
                ...
                drawer_id_number=request.form.get("drawer_id_number") or "",
                payee_name=request.form.get("payee_name") or "",
