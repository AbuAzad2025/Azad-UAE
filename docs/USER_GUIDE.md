...
> هذا الدليل مُنشأ بالكامل من دراسة الكود المصدري للنظام. كل ما ورد هنا موجود فعلياً في الملفات والجداول والـ endpoints.
...
**تم إعداد هذا الدليل بالكامل من دراسة الكود المصدري.**
**الإصدار:** مطابق للكود في commit `e7b6b3e8` (آخر push).
