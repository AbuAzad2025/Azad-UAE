...
def register_reset_platform_db_command(app):
    ...
    def reset_platform_db(yes):
        ...
        click.echo(
            f"Done. Tenants in database: {tenant_count} (clean baseline -- tenants are provisioned via seed commands)"
        )
...
def _do_seed_demo(_app):
    ...
    suppliers = [
        {
            "name": "المورد العالمي",
            "name_ar": "المورد العالمي",
            "phone": "0506666666",
            "company_name": "Global Supply Co",
        },
        {
            "name": "مؤسسة الخليج",
            "name_ar": "مؤسسة الخليج",
            "phone": "0507777777",
            "company_name": "Gulf Trading",
        },
        {
            "name": "شركة الاتحاد",
            "name_ar": "شركة الاتحاد",
            "phone": "0508888888",
            "company_name": "Al-Ittihad LLC",
        },
        {
            "name": "الشرق الأوسط للتجارة",
            "name_ar": "الشرق الأوسط للتجارة",
            "phone": "0509999999",
            "company_name": "Middle East Trade",
        },
        {
            "name": "مصنع الإمارات",
            "name_ar": "مصنع الإمارات",
            "phone": "0501010101",
            "company_name": "Emirates Factory",
        },
    ]
    partners = [
        {
    ...
    db.session.commit()
    click.echo(
        "Demo tenant seeded successfully (branches, warehouses, users, products, partners, "
