...
class AzadNeuralEngine:
    ...
    def _train_accounting_internal(self):
        ...
        return {"success": True, "accuracy": accuracy, "samples": len(entries)}
    ...
    def _train_financial_internal(self):
        ...
        for month_offset in range(12):  # آخر 12 شهر
            ...
            # المشتريات
            purchases = (
                db.session.query(func.sum(Purchase.amount_aed))
                .filter(
            ...
            # المقبوضات
            receipts = (
                db.session.query(func.sum(Receipt.amount_aed))
                .filter(
        ...
        return {"success": True, "r2_score": r2, "samples": len(monthly_data)}
    ...
    def _train_sales_internal(self):
        ...
        return {"success": True, "r2_score": r2, "samples": len(daily_sales)}
    ...
    def _train_customer_internal(self):
        ...
        return {"success": True, "accuracy": accuracy, "samples": len(customers_data)}
    ...
    def _train_fraud_internal(self):
        ...
        return {"success": True, "accuracy": accuracy, "samples": len(sales)}
    ...
    def _train_inventory_internal(self):
        ...
        return {"success": True, "r2_score": r2, "samples": len(products_data)}
