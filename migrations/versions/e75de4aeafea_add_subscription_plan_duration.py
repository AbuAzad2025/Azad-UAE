...
def upgrade():
    ...
    with op.batch_alter_table("package_purchases", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key("package_purchases_tenant_id_fkey", "tenants", ["tenant_id"], ["id"])
...
def downgrade():
    ...
    with op.batch_alter_table("package_purchases", schema=None) as batch_op:
        batch_op.drop_constraint("package_purchases_tenant_id_fkey", type_="foreignkey")
