...
NASRALLAH_ACCOUNTS = [
    ('1000', 'Assets', 'الأصول', 'asset', 0, True, None, None, None),
    ('1100', 'Current Assets', 'أصول متداولة', 'asset', 1, True, '1000', None, None),
    ('1110', 'Cash and Cash Equivalents', 'النقد وما في حكمه', 'asset', 2, True, '1100', None, None),
    ('1111', 'Cash Box (Main)', 'الصندوق الرئيسي', 'asset', 3, False, '1110', None, None),
    ('1112', 'Cash Box (Branch)', 'صندوق الفرع', 'asset', 3, False, '1110', None, None),
    ('1120', 'Bank Accounts', 'الحسابات البنكية', 'asset', 2, True, '1100', None, None),
    ('1130', 'Accounts Receivable', 'العملاء (ذمم مدينة)', 'asset', 2, False, '1100', None, None),
    ('1131', 'AR - Trade Customers', 'عملاء التجارة', 'asset', 3, False, '1130', None, None),
    ('1132', 'AR - Partners', 'عملاء الشراكة', 'asset', 3, False, '1130', None, None),
    ('1133', 'AR - Staff', 'ذمم الموظفين', 'asset', 3, False, '1130', None, None),
    ('1140', 'Inventory', 'المخزون', 'asset', 2, False, '1100', None, None),
    ('1141', 'Inventory - Finished Goods', 'مخزون بضاعة جاهزة', 'asset', 3, False, '1140', None, None),
    ('1142', 'Inventory - Raw Materials', 'مخزون مواد أولية', 'asset', 3, False, '1140', None, None),
    ('1143', 'Inventory - Spare Parts', 'مخزون قطع غيار', 'asset', 3, False, '1140', None, None),
    ('1150', 'Cheques Under Collection', 'شيكات برسم التحصيل', 'asset', 2, False, '1100', None, None),
    ('1160', 'Prepayments', 'مدفوعات مقدمة', 'asset', 2, False, '1100', None, None),
    ('1170', 'Employee Advances', 'سلف الموظفين', 'asset', 2, False, '1100', None, None),
    ('1180', 'Fixed Assets', 'الأصول الثابتة', 'asset', 2, True, '1100', None, None),
    ('1190', 'Accumulated Depreciation', 'مجمع الإهلاك', 'asset', 2, False, '1100', None, None),
    ('1200', 'Non-Current Assets', 'أصول غير متداولة', 'asset', 1, True, '1000', None, None),
    ('2000', 'Liabilities', 'الخصوم', 'liability', 0, True, None, None, None),
    ('2100', 'Current Liabilities', 'خصوم متداولة', 'liability', 1, True, '2000', None, None),
    ('2110', 'Accounts Payable', 'الموردين (ذمم دائنة)', 'liability', 2, False, '2100', None, None),
    ('2111', 'AP - Suppliers', 'موردين', 'liability', 3, False, '2110', None, None),
    ('2112', 'AP - Trade Payables', 'ذمم دائنة تجارية', 'liability', 3, False, '2110', None, None),
    ('2120', 'VAT Payable', 'ضريبة القيمة المضافة', 'liability', 2, False, '2100', None, None),
    ('2121', 'VAT Output', 'ضريبة مخرجات', 'liability', 3, False, '2120', None, None),
    ('2122', 'VAT Input', 'ضريبة مدخلات', 'liability', 3, False, '2120', None, None),
    ('2130', 'Deferred Cheques Payable', 'شيكات برسم الدفع', 'liability', 2, False, '2100', None, None),
    ('2140', 'End of Service Benefits Provision', 'مخصص نهاية الخدمة للموظفين', 'liability', 2, False, '2100', None, None),
    ('2141', 'Payroll Payable', 'رواتب مستحقة', 'liability', 2, False, '2100', None, None),
    ('2150', 'Partner Current Accounts', 'حسابات الشركاء الجارية', 'liability', 2, False, '2100', None, None),
    ('2151', 'Partner - Merchant Account', 'حساب التاجر', 'liability', 3, False, '2150', None, None),
    ('2152', 'Partner - Commission Hold', 'عمولات محتجزة', 'liability', 3, False, '2150', None, None),
    ('2160', 'Accrued Vacations Provision', 'مخصص استحقاقات الإجازات السنوية', 'liability', 2, False, '2100', None, None),
    ('2161', 'Loyalty Points Liability', 'التزام نقاط الولاء', 'liability', 2, False, '2100', None, None),
    ('2170', 'Customer Deposits', 'عربون العملاء', 'liability', 2, False, '2100', None, None),
    ('2180', 'Azad Platform Payable', 'ذمم دائنة - منصة أزاد', 'liability', 2, False, '2100', None, None),
    ('2181', 'Azad Platform Fee Accrued', 'رسوم منصة متراكمة', 'liability', 3, False, '2180', None, None),
    ('2182', 'Azad Platform Fee Paid', 'رسوم منصة مدفوعة', 'liability', 3, False, '2180', None, None),
    ('2200', 'Non-Current Liabilities', 'خصوم غير متداولة', 'liability', 1, True, '2000', None, None),
    ('3000', 'Equity', 'حقوق الملكية', 'equity', 0, True, None, None, None),
    ('3100', 'Capital', 'رأس المال', 'equity', 1, False, '3000', None, None),
    ('3130', 'Opening Balance Equity', 'رصيد افتتاحي', 'equity', 1, False, '3000', None, None),
    ('3200', 'Retained Earnings', 'أرباح مرحلة', 'equity', 1, False, '3000', None, None),
    ('3300', 'Owner Drawings', 'مسحوبات المالك', 'equity', 1, False, '3000', None, None),
    ('4000', 'Revenue', 'الإيرادات', 'revenue', 0, True, None, None, None),
    ('4100', 'Sales Revenue', 'إيرادات المبيعات', 'revenue', 1, False, '4000', None, None),
    ('4101', 'Sales - Retail', 'مبيعات التجزئة', 'revenue', 2, False, '4100', None, None),
    ('4102', 'Sales - Wholesale', 'مبيعات الجملة', 'revenue', 2, False, '4100', None, None),
    ('4103', 'Sales - Online Store', 'مبيعات المتجر الإلكتروني', 'revenue', 2, False, '4100', None, None),
    ('4104', 'Sales - Services', 'إيرادات الخدمات', 'revenue', 2, False, '4100', None, None),
    ('4200', 'Shipping Revenue', 'إيرادات الشحن', 'revenue', 1, False, '4000', None, None),
    ('4300', 'Other Revenue', 'إيرادات أخرى', 'revenue', 1, False, '4000', None, None),
    ('4400', 'FX Gains', 'أرباح صرف العملات', 'revenue', 1, False, '4000', None, None),
    ('4500', 'Donation Revenue', 'إيرادات التبرعات', 'revenue', 1, False, '4000', None, None),
    ('4600', 'Fixed Asset Disposal Gain', 'أرباح بيع الأصول', 'revenue', 1, False, '4000', None, None),
    ('4700', 'Azad Subscription Revenue', 'إيرادات اشتراك أزاد', 'revenue', 1, False, '4000', None, None),
    ('5000', 'Cost of Sales', 'تكلفة المبيعات', 'expense', 0, True, None, None, None),
    ('5100', 'Cost of Goods Sold', 'تكلفة البضاعة المباعة', 'expense', 1, False, '5000', None, None),
    ('5101', 'COGS - Retail', 'تكلفة بضاعة تجزئة', 'expense', 2, False, '5100', None, None),
    ('5102', 'COGS - Wholesale', 'تكلفة بضاعة جملة', 'expense', 2, False, '5100', None, None),
    ('5103', 'COGS - Online', 'تكلفة بضاعة أونلاين', 'expense', 2, False, '5100', None, None),
    ('5150', 'Inventory Adjustment', 'تسوية تكلفة المخزون', 'expense', 1, False, '5000', None, None),
    ('5200', 'Inventory Adjustments', 'تسويات المخزون', 'expense', 1, True, '5000', None, None),
    ('5201', 'Inventory Gain', 'ربح مخزوني', 'expense', 2, False, '5200', None, None),
    ('5202', 'Inventory Loss', 'خسارة مخزونية', 'expense', 2, False, '5200', None, None),
    ('5300', 'Landed Costs', 'تكاليف الشحن والجمارك', 'expense', 1, True, '5000', None, None),
    ('5301', 'Freight In', 'شحن وارد', 'expense', 2, False, '5300', None, None),
    ('5302', 'Customs Duty', 'رسوم جمركية', 'expense', 2, False, '5300', None, None),
    ('5303', 'Insurance In', 'تأمين وارد', 'expense', 2, False, '5300', None, None),
    ('6000', 'Operating Expenses', 'مصروفات تشغيلية', 'expense', 0, True, None, None, None),
    ('6100', 'Sales & Marketing Expenses', 'مصروفات تسويق ومبيعات', 'expense', 1, True, '6000', None, None),
    ('6110', 'Advertising & Marketing', 'إعلان وتسويق', 'expense', 2, False, '6100', None, None),
    ('6120', 'Sales Commissions', 'عمولات المبيعات', 'expense', 2, False, '6100', None, None),
    ('6130', 'Store Discounts & Coupons', 'خصومات وكوبونات', 'expense', 2, False, '6100', None, None),
    ('6131', 'Campaign Discounts', 'خصومات الحملات', 'expense', 2, False, '6100', None, None),
    ('6140', 'Shipping & Delivery Cost', 'تكلفة الشحن والتوصيل', 'expense', 2, False, '6100', None, None),
    ('6150', 'Partner Commissions', 'عمولات الشركاء', 'expense', 2, False, '6100', None, None),
    ('6190', 'End of Service Provision Expenses', 'مصروف مخصص نهاية الخدمة', 'expense', 1, False, '6000', None, None),
    ('6200', 'Administrative Expenses', 'مصروفات إدارية', 'expense', 1, True, '6000', None, None),
    ('6210', 'Rent', 'الإيجار', 'expense', 2, False, '6200', None, None),
    ('6220', 'Salaries & Wages', 'الرواتب والأجور', 'expense', 2, False, '6200', None, None),
    ('6230', 'Utilities', 'الكهرباء والمياه', 'expense', 2, False, '6200', None, None),
    ('6240', 'Maintenance & Repairs', 'صيانة وإصلاحات', 'expense', 2, False, '6200', None, None),
    ('6250', 'Office Supplies', 'قرطاسية ومستلزمات', 'expense', 2, False, '6200', None, None),
    ('6260', 'Bank Fees & Charges', 'رسوم بنكية', 'expense', 2, False, '6200', None, None),
    ('6270', 'Insurance', 'تأمين', 'expense', 2, False, '6200', None, None),
    ('6280', 'Legal & Professional Fees', 'رسوم قانونية', 'expense', 2, False, '6200', None, None),
    ('6290', 'Communication', 'اتصالات', 'expense', 2, False, '6200', None, None),
    ('6300', 'Depreciation Expense', 'مصروف الإهلاك', 'expense', 1, False, '6000', None, None),
    ('6400', 'Warranty Claims', 'مطالبات الضمان', 'expense', 1, False, '6000', None, None),
    ('6410', 'Platform Subscription Expense', 'مصروف اشتراك المنصة', 'expense', 2, False, '6000', None, None),
    ('6500', 'Miscellaneous Expenses', 'مصروفات متنوعة', 'expense', 1, False, '6000', None, None),
    ('6600', 'FX Losses', 'خسائر صرف العملات', 'expense', 1, False, '6000', None, None),
    ('6700', 'Fixed Asset Disposal Loss', 'خسائر بيع الأصول', 'expense', 1, False, '6000', None, None),
]
...
NASRALLAH_MAPPINGS = [
    ...
    ('SALES_RETURNS', '4100'),
    ('SALES_DISCOUNT', '6130'),
    ('SALES_COMMISSION', '6120'),
    ('TIER_DISCOUNT', '4100'),
    ('AR', '1130'),
    ('AP', '2110'),
    ('PURCHASE_RETURNS', '2110'),
    ('INVENTORY_ASSET', '1140'),
    ('COGS', '5100'),
    ('FREIGHT_IN', '5301'),
    ('CUSTOMS_DUTY', '5302'),
    ('CHEQUES_UNDER_COLLECTION', '1150'),
    ('DEFERRED_CHEQUES_PAYABLE', '2130'),
    ('BANK_FEES', '6260'),
    ('CARD_PROCESSING_FEES', '6260'),
    ('COGS_REVERSAL', '5100'),
    ('INVENTORY_ADJUSTMENT_GAIN', '5150'),
    ('INVENTORY_ADJUSTMENT_LOSS', '5150'),
...
def upgrade():
    ...
    conn.execute(text(
        ...
        "name": "Nasrallah", "name_ar": "\u0646\u0635\u0631\u0627\u0644\u0644\u0647",
    ...
    conn.execute(text(
        ...
        "SELECT " + _TID + ", 'Nasrallah', '\u0646\u0635\u0631\u0627\u0644\u0644\u0647', :logo, :logo, TRUE, CURRENT_TIMESTAMP "
    ...
    conn.execute(text(
        ...
        "SELECT " + _TID + ", 'Main Warehouse', '\u0627\u0644\u0645\u0633\u062a\u0648\u062f\u0639 \u0627\u0644\u0631\u0626\u064a\u0633\u064a', "
    ...
    for (code, name, name_ar, typ, level, is_header, parent_code, ind, mod) in NASRALLAH_ACCOUNTS:
        ...
        conn.execute(text(
            ...
            "currency": "ILS", "is_header": bool(is_header),
