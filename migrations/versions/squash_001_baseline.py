...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "subscription_yearly_fee_aed",
            sa.Numeric(precision=15, scale=3),
            nullable=True,
        ),
        sa.Column(
            "subscription_perpetual_fee_aed",
            sa.Numeric(precision=15, scale=3),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            name="uq_bank_reconciliations_tenant_number",
        ),
    )
    op.create_table(
        "budget_lines",
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            "month",
            "year",
            name="uq_payroll_tenant_employee_period",
        ),
    )
    op.create_table(
        "pos_tables",
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "tenant_id",
            "return_number",
            name="uq_purchase_returns_tenant_return_number",
        ),
    )
    op.create_table(
        "sales",
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            "product_id",
            "warehouse_id",
            name="uq_pwc_tenant_product_warehouse",
        ),
    )
    op.create_table(
    ...
    with op.batch_alter_table("industry_field_definitions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_industry_field_definitions_industry_code"),
            ["industry_code"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_industry_field_definitions_is_active"),
            ["is_active"],
            unique=False,
        )
    ...
    with op.batch_alter_table("store_payment_methods", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_store_payment_methods_is_enabled"),
            ["is_enabled"],
            unique=False,
        )
    ...
    with op.batch_alter_table("azad_subscription_fees", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_azad_subscription_fees_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            "ix_azad_subscription_fees_tenant_status",
            ["tenant_id", "status"],
            unique=False,
        )
    ...
    with op.batch_alter_table("document_verifications", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_document_verifications_document_hash"),
            ["document_hash"],
            unique=True,
        )
        batch_op.create_index(
            batch_op.f("ix_document_verifications_public_token"),
            ["public_token"],
            unique=True,
        )
        batch_op.create_index(
    ...
    with op.batch_alter_table("exchange_rate_records", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_exchange_rate_records_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_exchange_rate_records_created_by"),
            ["created_by"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_exchange_rate_records_effective_date"),
            ["effective_date"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_exchange_rate_records_from_currency"),
            ["from_currency"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_exchange_rate_records_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_exchange_rate_records_to_currency"),
            ["to_currency"],
            unique=False,
        )
    ...
    with op.batch_alter_table("gl_journal_entries", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_gl_journal_entries_reversed_entry_id"),
            ["reversed_entry_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("integration_settings", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_integration_settings_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_integration_settings_service_name"),
            ["service_name"],
            unique=False,
        )
    ...
    with op.batch_alter_table("warehouses", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_warehouses_allow_negative_inventory"),
    ...
    with op.batch_alter_table("advanced_expenses", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_advanced_expenses_approved_by"),
            ["approved_by"],
            unique=False,
        )
        ...
        batch_op.create_index(
            batch_op.f("ix_advanced_expenses_expense_number"),
            ["expense_number"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_advanced_expenses_gl_journal_entry_id"),
            ["gl_journal_entry_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_advanced_expenses_reversed_by"),
            ["reversed_by"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_advanced_expenses_supplier_id"),
            ["supplier_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("bank_reconciliations", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliations_approved_by"),
            ["approved_by"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliations_bank_account_id"),
            ["bank_account_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliations_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliations_created_by"),
            ["created_by"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliations_period_end"),
            ["period_end"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliations_reconciliation_number"),
            ["reconciliation_number"],
            unique=False,
        )
    ...
    with op.batch_alter_table("fixed_assets", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_fixed_assets_asset_account_id"),
            ["asset_account_id"],
            unique=False,
        )
        ...
        batch_op.create_index(
            batch_op.f("ix_fixed_assets_expense_account_id"),
            ["expense_account_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("gl_account_mappings", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_gl_account_mappings_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_gl_account_mappings_gl_account_id"),
            ["gl_account_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("journal_entry_audits", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_journal_entry_audits_journal_entry_id"),
            ["journal_entry_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_journal_entry_audits_performed_by"),
            ["performed_by"],
            unique=False,
        )
    ...
    with op.batch_alter_table("partner_profit_distributions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_partner_profit_distributions_approved_by"),
            ["approved_by"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_profit_distributions_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_profit_distributions_created_by"),
            ["created_by"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_profit_distributions_partner_id"),
            ["partner_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_profit_distributions_status"),
            ["status"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_profit_distributions_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("payment_transactions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_payment_transactions_created_at"),
            ["created_at"],
            unique=False,
        )
    ...
    with op.batch_alter_table("payroll_transactions", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_payroll_transactions_employee_id"),
            ["employee_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_payroll_transactions_gl_entry_id"),
            ["gl_entry_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("bank_reconciliation_items", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliation_items_cheque_id"),
            ["cheque_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliation_items_journal_entry_id"),
            ["journal_entry_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliation_items_reconciliation_id"),
            ["reconciliation_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_reconciliation_items_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("depreciation_schedules", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_depreciation_schedules_journal_entry_id"),
            ["journal_entry_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_depreciation_schedules_period_date"),
            ["period_date"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_depreciation_schedules_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("partner_transactions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_partner_transactions_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_transactions_created_by"),
            ["created_by"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_transactions_distribution_id"),
            ["distribution_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_transactions_partner_id"),
            ["partner_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("products", schema=None) as batch_op:
        ...
        batch_op.create_index(
            ...
            ["tenant_id", "sku"],
            unique=True,
            postgresql_where=sa.text("(sku IS NOT NULL) AND (TRIM(sku::text) <> '')"),
        )
    ...
    with op.batch_alter_table("shop_customer_accounts", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_shop_customer_accounts_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_customer_accounts_customer_id"),
            ["customer_id"],
            unique=False,
        )
        ...
        batch_op.create_index(
            batch_op.f("ix_shop_customer_accounts_password_reset_token"),
            ["password_reset_token"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_customer_accounts_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("tax_calculation_rules", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_tax_calculation_rules_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_tax_calculation_rules_is_active"),
            ["is_active"],
            unique=False,
        )
    ...
    with op.batch_alter_table("tickets", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_tickets_assigned_user_id"),
            ["assigned_user_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("bank_statement_lines", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_bank_statement_lines_bank_account_id"),
            ["bank_account_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_statement_lines_created_by"),
            ["created_by"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_statement_lines_matched_by"),
            ["matched_by"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_statement_lines_matched_cheque_id"),
            ["matched_cheque_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_statement_lines_matched_journal_entry_id"),
            ["matched_journal_entry_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_bank_statement_lines_reconciliation_item_id"),
    ...
    with op.batch_alter_table("fiscal_position_tax_rules", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_fiscal_position_tax_rules_fiscal_position_id"),
            ["fiscal_position_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_fiscal_position_tax_rules_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("product_cost_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_product_cost_history_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_product_cost_history_product_id"),
            ["product_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("product_price_tiers", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_product_price_tiers_created_at"),
            ["created_at"],
            unique=False,
        )
    ...
    with op.batch_alter_table("product_returns", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_product_returns_reverses_invoice_id"),
            ["reverses_invoice_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("product_warehouse_stock", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_product_warehouse_stock_product_id"),
            ["product_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_product_warehouse_stock_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_product_warehouse_stock_warehouse_id"),
            ["warehouse_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("shop_abandoned_carts", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_shop_abandoned_carts_account_id"),
            ["account_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_abandoned_carts_created_at"),
            ["created_at"],
            unique=False,
        )
    ...
    with op.batch_alter_table("shop_loyalty_transactions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_shop_loyalty_transactions_account_id"),
            ["account_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_loyalty_transactions_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_loyalty_transactions_sale_id"),
            ["sale_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_loyalty_transactions_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("shop_product_variants", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_shop_product_variants_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_product_variants_is_active"),
            ["is_active"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_product_variants_product_id"),
            ["product_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_product_variants_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("shop_saved_payments", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_shop_saved_payments_account_id"),
            ["account_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_shop_saved_payments_created_at"),
            ["created_at"],
            unique=False,
        )
    ...
    with op.batch_alter_table("partner_commission_entries", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_partner_commission_entries_branch_id"),
            ["branch_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_commission_entries_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_commission_entries_partner_customer_id"),
            ["partner_customer_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_commission_entries_product_id"),
            ["product_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_commission_entries_sale_id"),
            ["sale_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_commission_entries_sale_line_id"),
            ["sale_line_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_commission_entries_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_partner_commission_entries_warehouse_id"),
            ["warehouse_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("product_return_lines", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_product_return_lines_product_id"),
            ["product_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("product_serials", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_product_serials_sale_line_id"),
            ["sale_line_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_product_serials_serial_number"),
            ["serial_number"],
            unique=False,
        )
        ...
        batch_op.create_index(
            ...
            ["tenant_id", "imei1"],
            unique=False,
            sqlite_where=sa.text("imei1 IS NOT NULL AND imei1 != ''"),
            postgresql_where=sa.text("imei1 IS NOT NULL AND imei1 != ''"),
        )
        batch_op.create_index(
            "ix_serial_tenant_imei2",
            ["tenant_id", "imei2"],
            unique=False,
            sqlite_where=sa.text("imei2 IS NOT NULL AND imei2 != ''"),
            postgresql_where=sa.text("imei2 IS NOT NULL AND imei2 != ''"),
        )

    with op.batch_alter_table("product_warehouse_costs", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_product_warehouse_costs_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_product_warehouse_costs_product_id"),
            ["product_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_product_warehouse_costs_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_product_warehouse_costs_updated_by_movement_id"),
            ["updated_by_movement_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_product_warehouse_costs_warehouse_id"),
            ["warehouse_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("purchase_return_lines", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_purchase_return_lines_product_id"),
            ["product_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_purchase_return_lines_purchase_line_id"),
            ["purchase_line_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_purchase_return_lines_return_id"),
            ["return_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_purchase_return_lines_tenant_id"),
            ["tenant_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("document_snapshots"):
        op.create_foreign_key(
            "fk_document_snapshots_created_by",
            "document_snapshots",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("document_snapshots"):
        op.create_foreign_key(
            "fk_document_snapshots_tenant_id",
            "document_snapshots",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("document_verifications"):
        op.create_foreign_key(
            "fk_document_verifications_created_by",
            "document_verifications",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("document_verifications"):
        op.create_foreign_key(
            "fk_document_verifications_tenant_id",
            "document_verifications",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("error_audit_logs"):
        op.create_foreign_key(
            "fk_error_audit_logs_resolved_by",
            "error_audit_logs",
            "users",
            ["resolved_by"],
            ["id"],
    ...
    with op.batch_alter_table("exchange_rate_records"):
        op.create_foreign_key(
            "fk_exchange_rate_records_created_by",
            "exchange_rate_records",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("exchange_rate_records"):
        op.create_foreign_key(
            "fk_exchange_rate_records_tenant_id",
            "exchange_rate_records",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("expense_categories"):
        op.create_foreign_key(
            "fk_expense_categories_tenant_id",
            "expense_categories",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_journal_entries"):
        op.create_foreign_key(
            "fk_gl_journal_entries_branch_id",
            "gl_journal_entries",
            "branches",
            ["branch_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_journal_entries"):
        op.create_foreign_key(
            "fk_gl_journal_entries_created_by",
            "gl_journal_entries",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("gl_journal_entries"):
        op.create_foreign_key(
            "fk_gl_journal_entries_reversed_entry_id",
            "gl_journal_entries",
            "gl_journal_entries",
            ["reversed_entry_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_journal_entries"):
        op.create_foreign_key(
            "fk_gl_journal_entries_tenant_id",
            "gl_journal_entries",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("integration_settings"):
        op.create_foreign_key(
            "fk_integration_settings_tenant_id",
            "integration_settings",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("integration_settings"):
        op.create_foreign_key(
            "fk_integration_settings_updated_by",
            "integration_settings",
            "users",
            ["updated_by"],
            ["id"],
    ...
    with op.batch_alter_table("invoice_settings"):
        op.create_foreign_key(
            "fk_invoice_settings_updated_by",
            "invoice_settings",
            "users",
            ["updated_by"],
            ["id"],
    ...
    with op.batch_alter_table("ticket_categories"):
        op.create_foreign_key(
            "fk_ticket_categories_auto_assign_user_id",
            "ticket_categories",
            "users",
            ["auto_assign_user_id"],
            ["id"],
    ...
    with op.batch_alter_table("ticket_categories"):
        op.create_foreign_key(
            "fk_ticket_categories_tenant_id",
            "ticket_categories",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("ticket_priorities"):
        op.create_foreign_key(
            "fk_ticket_priorities_tenant_id",
            "ticket_priorities",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("advanced_expenses"):
        op.create_foreign_key(
            "fk_advanced_expenses_approved_by",
            "advanced_expenses",
            "users",
            ["approved_by"],
            ["id"],
    ...
    with op.batch_alter_table("advanced_expenses"):
        op.create_foreign_key(
            "fk_advanced_expenses_branch_id",
            "advanced_expenses",
            "branches",
            ["branch_id"],
            ["id"],
    ...
    with op.batch_alter_table("advanced_expenses"):
        op.create_foreign_key(
            "fk_advanced_expenses_category_id",
            "advanced_expenses",
            "expense_categories",
            ["category_id"],
            ["id"],
    ...
    with op.batch_alter_table("advanced_expenses"):
        op.create_foreign_key(
            "fk_advanced_expenses_created_by",
            "advanced_expenses",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("advanced_expenses"):
        op.create_foreign_key(
            "fk_advanced_expenses_gl_journal_entry_id",
            "advanced_expenses",
            "gl_journal_entries",
            ["gl_journal_entry_id"],
            ["id"],
    ...
    with op.batch_alter_table("advanced_expenses"):
        op.create_foreign_key(
            "fk_advanced_expenses_reversed_by",
            "advanced_expenses",
            "users",
            ["reversed_by"],
            ["id"],
    ...
    with op.batch_alter_table("advanced_expenses"):
        op.create_foreign_key(
            "fk_advanced_expenses_supplier_id",
            "advanced_expenses",
            "suppliers",
            ["supplier_id"],
            ["id"],
    ...
    with op.batch_alter_table("advanced_expenses"):
        op.create_foreign_key(
            "fk_advanced_expenses_tenant_id",
            "advanced_expenses",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_reconciliations"):
        op.create_foreign_key(
            "fk_bank_reconciliations_approved_by",
            "bank_reconciliations",
            "users",
            ["approved_by"],
            ["id"],
    ...
    with op.batch_alter_table("bank_reconciliations"):
        op.create_foreign_key(
            "fk_bank_reconciliations_bank_account_id",
            "bank_reconciliations",
            "gl_accounts",
            ["bank_account_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_reconciliations"):
        op.create_foreign_key(
            "fk_bank_reconciliations_created_by",
            "bank_reconciliations",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("customers"):
        op.create_foreign_key(
            "fk_customers_fiscal_position_id",
            "customers",
            "fiscal_positions",
            ["fiscal_position_id"],
            ["id"],
    ...
    with op.batch_alter_table("customs_taxes"):
        op.create_foreign_key(
            "fk_customs_taxes_gl_account_id",
            "customs_taxes",
            "gl_accounts",
            ["gl_account_id"],
            ["id"],
    ...
    with op.batch_alter_table("email_campaigns"):
        op.create_foreign_key(
            "fk_email_campaigns_template_id",
            "email_campaigns",
            "email_templates",
            ["template_id"],
            ["id"],
    ...
    with op.batch_alter_table("employee_leaves"):
        op.create_foreign_key(
            "fk_employee_leaves_employee_id",
            "employee_leaves",
            "employees",
            ["employee_id"],
            ["id"],
    ...
    with op.batch_alter_table("fixed_assets"):
        op.create_foreign_key(
            "fk_fixed_assets_cost_center_id",
            "fixed_assets",
            "cost_centers",
            ["cost_center_id"],
            ["id"],
    ...
    with op.batch_alter_table("fixed_assets"):
        op.create_foreign_key(
            "fk_fixed_assets_depreciation_account_id",
            "fixed_assets",
            "gl_accounts",
            ["depreciation_account_id"],
            ["id"],
    ...
    with op.batch_alter_table("fixed_assets"):
        op.create_foreign_key(
            "fk_fixed_assets_expense_account_id",
            "fixed_assets",
            "gl_accounts",
            ["expense_account_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_account_mappings"):
        op.create_foreign_key(
            "fk_gl_account_mappings_branch_id",
            "gl_account_mappings",
            "branches",
            ["branch_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_account_mappings"):
        op.create_foreign_key(
            "fk_gl_account_mappings_gl_account_id",
            "gl_account_mappings",
            "gl_accounts",
            ["gl_account_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_account_mappings"):
        op.create_foreign_key(
            "fk_gl_account_mappings_tenant_id",
            "gl_account_mappings",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_journal_lines"):
        op.create_foreign_key(
            "fk_gl_journal_lines_account_id",
            "gl_journal_lines",
            "gl_accounts",
            ["account_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_journal_lines"):
        op.create_foreign_key(
            "fk_gl_journal_lines_cost_center_id",
            "gl_journal_lines",
            "cost_centers",
            ["cost_center_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_journal_lines"):
        op.create_foreign_key(
            "fk_gl_journal_lines_partner_id",
            "gl_journal_lines",
            "partners",
            ["partner_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_journal_lines"):
        op.create_foreign_key(
            "fk_gl_journal_lines_profit_center_id",
            "gl_journal_lines",
            "profit_centers",
            ["profit_center_id"],
            ["id"],
    ...
    with op.batch_alter_table("gl_journal_lines"):
        op.create_foreign_key(
            "fk_gl_journal_lines_warehouse_id",
            "gl_journal_lines",
            "warehouses",
            ["warehouse_id"],
            ["id"],
    ...
    with op.batch_alter_table("job_positions"):
        op.create_foreign_key(
            "fk_job_positions_department_id",
            "job_positions",
            "departments",
            ["department_id"],
            ["id"],
    ...
    with op.batch_alter_table("journal_entry_audits"):
        op.create_foreign_key(
            "fk_journal_entry_audits_journal_entry_id",
            "journal_entry_audits",
            "gl_journal_entries",
            ["journal_entry_id"],
            ["id"],
    ...
    with op.batch_alter_table("journal_entry_audits"):
        op.create_foreign_key(
            "fk_journal_entry_audits_performed_by",
            "journal_entry_audits",
            "users",
            ["performed_by"],
            ["id"],
    ...
    with op.batch_alter_table("journal_entry_audits"):
        op.create_foreign_key(
            "fk_journal_entry_audits_tenant_id",
            "journal_entry_audits",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_profit_distributions"):
        op.create_foreign_key(
            "fk_partner_profit_distributions_approved_by",
            "partner_profit_distributions",
            "users",
            ["approved_by"],
            ["id"],
    ...
    with op.batch_alter_table("partner_profit_distributions"):
        op.create_foreign_key(
            "fk_partner_profit_distributions_created_by",
            "partner_profit_distributions",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("partner_profit_distributions"):
        op.create_foreign_key(
            "fk_partner_profit_distributions_partner_id",
            "partner_profit_distributions",
            "partners",
            ["partner_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_profit_distributions"):
        op.create_foreign_key(
            "fk_partner_profit_distributions_tenant_id",
            "partner_profit_distributions",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("payment_transactions"):
        op.create_foreign_key(
            "fk_payment_transactions_tenant_id",
            "payment_transactions",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("payment_transactions"):
        op.create_foreign_key(
            "fk_payment_transactions_vault_id",
            "payment_transactions",
            "payment_vault",
            ["vault_id"],
            ["id"],
    ...
    with op.batch_alter_table("payroll_transactions"):
        op.create_foreign_key(
            "fk_payroll_transactions_branch_id",
            "payroll_transactions",
            "branches",
            ["branch_id"],
            ["id"],
    ...
    with op.batch_alter_table("payroll_transactions"):
        op.create_foreign_key(
            "fk_payroll_transactions_created_by",
            "payroll_transactions",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("payroll_transactions"):
        op.create_foreign_key(
            "fk_payroll_transactions_employee_id",
            "payroll_transactions",
            "employees",
            ["employee_id"],
            ["id"],
    ...
    with op.batch_alter_table("payroll_transactions"):
        op.create_foreign_key(
            "fk_payroll_transactions_gl_entry_id",
            "payroll_transactions",
            "gl_journal_entries",
            ["gl_entry_id"],
            ["id"],
    ...
    with op.batch_alter_table("payroll_transactions"):
        op.create_foreign_key(
            "fk_payroll_transactions_tenant_id",
            "payroll_transactions",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("salary_advances"):
        op.create_foreign_key(
            "fk_salary_advances_employee_id",
            "salary_advances",
            "employees",
            ["employee_id"],
            ["id"],
    ...
    with op.batch_alter_table("salary_advances"):
        op.create_foreign_key(
            "fk_salary_advances_gl_entry_id",
            "salary_advances",
            "gl_journal_entries",
            ["gl_entry_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_reconciliation_items"):
        op.create_foreign_key(
            "fk_bank_reconciliation_items_cheque_id",
            "bank_reconciliation_items",
            "cheques",
            ["cheque_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_reconciliation_items"):
        op.create_foreign_key(
            "fk_bank_reconciliation_items_journal_entry_id",
            "bank_reconciliation_items",
            "gl_journal_entries",
            ["journal_entry_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_reconciliation_items"):
        op.create_foreign_key(
            "fk_bank_reconciliation_items_reconciliation_id",
            "bank_reconciliation_items",
            "bank_reconciliations",
            ["reconciliation_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_reconciliation_items"):
        op.create_foreign_key(
            "fk_bank_reconciliation_items_tenant_id",
            "bank_reconciliation_items",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("depreciation_schedules"):
        op.create_foreign_key(
            "fk_depreciation_schedules_asset_id",
            "depreciation_schedules",
            "fixed_assets",
            ["asset_id"],
            ["id"],
    ...
    with op.batch_alter_table("depreciation_schedules"):
        op.create_foreign_key(
            "fk_depreciation_schedules_journal_entry_id",
            "depreciation_schedules",
            "gl_journal_entries",
            ["journal_entry_id"],
            ["id"],
    ...
    with op.batch_alter_table("depreciation_schedules"):
        op.create_foreign_key(
            "fk_depreciation_schedules_tenant_id",
            "depreciation_schedules",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("email_subscribers"):
        op.create_foreign_key(
            "fk_email_subscribers_customer_id",
            "email_subscribers",
            "customers",
            ["customer_id"],
            ["id"],
    ...
    with op.batch_alter_table("email_subscribers"):
        op.create_foreign_key(
            "fk_email_subscribers_tenant_id",
            "email_subscribers",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_transactions"):
        op.create_foreign_key(
            "fk_partner_transactions_created_by",
            "partner_transactions",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("partner_transactions"):
        op.create_foreign_key(
            "fk_partner_transactions_distribution_id",
            "partner_transactions",
            "partner_profit_distributions",
            ["distribution_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_transactions"):
        op.create_foreign_key(
            "fk_partner_transactions_partner_id",
            "partner_transactions",
            "partners",
            ["partner_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_transactions"):
        op.create_foreign_key(
            "fk_partner_transactions_tenant_id",
            "partner_transactions",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("products"):
        op.create_foreign_key(
            "fk_products_merchant_customer_id",
            "products",
            "customers",
            ["merchant_customer_id"],
            ["id"],
    ...
    with op.batch_alter_table("purchase_returns"):
        op.create_foreign_key(
            "fk_purchase_returns_processed_by",
            "purchase_returns",
            "users",
            ["processed_by"],
            ["id"],
    ...
    with op.batch_alter_table("purchase_returns"):
        op.create_foreign_key(
            "fk_purchase_returns_purchase_id",
            "purchase_returns",
            "purchases",
            ["purchase_id"],
            ["id"],
    ...
    with op.batch_alter_table("purchase_returns"):
        op.create_foreign_key(
            "fk_purchase_returns_supplier_id",
            "purchase_returns",
            "suppliers",
            ["supplier_id"],
            ["id"],
    ...
    with op.batch_alter_table("purchase_returns"):
        op.create_foreign_key(
            "fk_purchase_returns_warehouse_id",
            "purchase_returns",
            "warehouses",
            ["warehouse_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_customer_accounts"):
        op.create_foreign_key(
            "fk_shop_customer_accounts_tenant_id",
            "shop_customer_accounts",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("tax_calculation_rules"):
        op.create_foreign_key(
            "fk_tax_calculation_rules_tax_id",
            "tax_calculation_rules",
            "customs_taxes",
            ["tax_id"],
            ["id"],
    ...
    with op.batch_alter_table("tax_calculation_rules"):
        op.create_foreign_key(
            "fk_tax_calculation_rules_tenant_id",
            "tax_calculation_rules",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("azad_platform_fees"):
        op.create_foreign_key(
            "fk_azad_platform_fees_payment_id",
            "azad_platform_fees",
            "payments",
            ["payment_id"],
            ["id"],
    ...
    with op.batch_alter_table("azad_platform_fees"):
        op.create_foreign_key(
            "fk_azad_platform_fees_tenant_id",
            "azad_platform_fees",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("azad_platform_fees"):
        op.create_foreign_key(
            "fk_azad_platform_fees_vault_id",
            "azad_platform_fees",
            "payment_vault",
            ["vault_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_statement_lines"):
        op.create_foreign_key(
            "fk_bank_statement_lines_bank_account_id",
            "bank_statement_lines",
            "gl_accounts",
            ["bank_account_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_statement_lines"):
        op.create_foreign_key(
            "fk_bank_statement_lines_created_by",
            "bank_statement_lines",
            "users",
            ["created_by"],
            ["id"],
    ...
    with op.batch_alter_table("bank_statement_lines"):
        op.create_foreign_key(
            "fk_bank_statement_lines_matched_by",
            "bank_statement_lines",
            "users",
            ["matched_by"],
            ["id"],
    ...
    with op.batch_alter_table("bank_statement_lines"):
        op.create_foreign_key(
            "fk_bank_statement_lines_matched_cheque_id",
            "bank_statement_lines",
            "cheques",
            ["matched_cheque_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_statement_lines"):
        op.create_foreign_key(
            "fk_bank_statement_lines_matched_journal_entry_id",
            "bank_statement_lines",
            "gl_journal_entries",
            ["matched_journal_entry_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_statement_lines"):
        op.create_foreign_key(
            "fk_bank_statement_lines_reconciliation_item_id",
            "bank_statement_lines",
            "bank_reconciliation_items",
            ["reconciliation_item_id"],
            ["id"],
    ...
    with op.batch_alter_table("bank_statement_lines"):
        op.create_foreign_key(
            "fk_bank_statement_lines_tenant_id",
            "bank_statement_lines",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("campaign_logs"):
        op.create_foreign_key(
            "fk_campaign_logs_subscriber_id",
            "campaign_logs",
            "email_subscribers",
            ["subscriber_id"],
            ["id"],
    ...
    with op.batch_alter_table("fiscal_position_tax_rules"):
        op.create_foreign_key(
            "fk_fiscal_position_tax_rules_destination_account_id",
            "fiscal_position_tax_rules",
            "gl_accounts",
    ...
    with op.batch_alter_table("fiscal_position_tax_rules"):
        op.create_foreign_key(
            "fk_fiscal_position_tax_rules_destination_tax_id",
            "fiscal_position_tax_rules",
            "tax_calculation_rules",
            ["destination_tax_id"],
            ["id"],
    ...
    with op.batch_alter_table("fiscal_position_tax_rules"):
        op.create_foreign_key(
            "fk_fiscal_position_tax_rules_fiscal_position_id",
            "fiscal_position_tax_rules",
            "fiscal_positions",
            ["fiscal_position_id"],
            ["id"],
    ...
    with op.batch_alter_table("fiscal_position_tax_rules"):
        op.create_foreign_key(
            "fk_fiscal_position_tax_rules_source_account_id",
            "fiscal_position_tax_rules",
            "gl_accounts",
            ["source_account_id"],
            ["id"],
    ...
    with op.batch_alter_table("fiscal_position_tax_rules"):
        op.create_foreign_key(
            "fk_fiscal_position_tax_rules_source_tax_id",
            "fiscal_position_tax_rules",
            "tax_calculation_rules",
            ["source_tax_id"],
            ["id"],
    ...
    with op.batch_alter_table("fiscal_position_tax_rules"):
        op.create_foreign_key(
            "fk_fiscal_position_tax_rules_tenant_id",
            "fiscal_position_tax_rules",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_cost_history"):
        op.create_foreign_key(
            "fk_product_cost_history_product_id",
            "product_cost_history",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_cost_history"):
        op.create_foreign_key(
            "fk_product_cost_history_tenant_id",
            "product_cost_history",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_cost_history"):
        op.create_foreign_key(
            "fk_product_cost_history_warehouse_id",
            "product_cost_history",
            "warehouses",
            ["warehouse_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_partners"):
        op.create_foreign_key(
            "fk_product_partners_partner_customer_id",
            "product_partners",
            "customers",
            ["partner_customer_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_partners"):
        op.create_foreign_key(
            "fk_product_partners_product_id",
            "product_partners",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_price_tiers"):
        op.create_foreign_key(
            "fk_product_price_tiers_product_id",
            "product_price_tiers",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_price_tiers"):
        op.create_foreign_key(
            "fk_product_price_tiers_tenant_id",
            "product_price_tiers",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_returns"):
        op.create_foreign_key(
            "fk_product_returns_customer_id",
            "product_returns",
            "customers",
            ["customer_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_returns"):
        op.create_foreign_key(
            "fk_product_returns_processed_by",
            "product_returns",
            "users",
            ["processed_by"],
            ["id"],
    ...
    with op.batch_alter_table("product_returns"):
        op.create_foreign_key(
            "fk_product_returns_reverses_invoice_id",
            "product_returns",
            "sales",
            ["reverses_invoice_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_warehouse_stock"):
        op.create_foreign_key(
            "fk_product_warehouse_stock_product_id",
            "product_warehouse_stock",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_warehouse_stock"):
        op.create_foreign_key(
            "fk_product_warehouse_stock_tenant_id",
            "product_warehouse_stock",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_warehouse_stock"):
        op.create_foreign_key(
            "fk_product_warehouse_stock_warehouse_id",
            "product_warehouse_stock",
            "warehouses",
            ["warehouse_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_abandoned_carts"):
        op.create_foreign_key(
            "fk_shop_abandoned_carts_account_id",
            "shop_abandoned_carts",
            "shop_customer_accounts",
            ["account_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_abandoned_carts"):
        op.create_foreign_key(
            "fk_shop_abandoned_carts_tenant_id",
            "shop_abandoned_carts",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_loyalty_transactions"):
        op.create_foreign_key(
            "fk_shop_loyalty_transactions_account_id",
            "shop_loyalty_transactions",
            "shop_customer_accounts",
            ["account_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_loyalty_transactions"):
        op.create_foreign_key(
            "fk_shop_loyalty_transactions_sale_id",
            "shop_loyalty_transactions",
            "sales",
            ["sale_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_loyalty_transactions"):
        op.create_foreign_key(
            "fk_shop_loyalty_transactions_tenant_id",
            "shop_loyalty_transactions",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_product_variants"):
        op.create_foreign_key(
            "fk_shop_product_variants_product_id",
            "shop_product_variants",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_product_variants"):
        op.create_foreign_key(
            "fk_shop_product_variants_tenant_id",
            "shop_product_variants",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_saved_payments"):
        op.create_foreign_key(
            "fk_shop_saved_payments_account_id",
            "shop_saved_payments",
            "shop_customer_accounts",
            ["account_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_saved_payments"):
        op.create_foreign_key(
            "fk_shop_saved_payments_tenant_id",
            "shop_saved_payments",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_stock_alerts"):
        op.create_foreign_key(
            "fk_shop_stock_alerts_product_id",
            "shop_stock_alerts",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("shop_stock_alerts"):
        op.create_foreign_key(
            "fk_shop_stock_alerts_tenant_id",
            "shop_stock_alerts",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_commission_entries"):
        op.create_foreign_key(
            "fk_partner_commission_entries_branch_id",
            "partner_commission_entries",
            "branches",
            ["branch_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_commission_entries"):
        op.create_foreign_key(
            "fk_partner_commission_entries_partner_customer_id",
            "partner_commission_entries",
            "customers",
            ["partner_customer_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_commission_entries"):
        op.create_foreign_key(
            "fk_partner_commission_entries_product_id",
            "partner_commission_entries",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_commission_entries"):
        op.create_foreign_key(
            "fk_partner_commission_entries_sale_id",
            "partner_commission_entries",
            "sales",
            ["sale_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_commission_entries"):
        op.create_foreign_key(
            "fk_partner_commission_entries_sale_line_id",
            "partner_commission_entries",
            "sale_lines",
            ["sale_line_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_commission_entries"):
        op.create_foreign_key(
            "fk_partner_commission_entries_tenant_id",
            "partner_commission_entries",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("partner_commission_entries"):
        op.create_foreign_key(
            "fk_partner_commission_entries_warehouse_id",
            "partner_commission_entries",
            "warehouses",
            ["warehouse_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_return_lines"):
        op.create_foreign_key(
            "fk_product_return_lines_product_id",
            "product_return_lines",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_return_lines"):
        op.create_foreign_key(
            "fk_product_return_lines_return_id",
            "product_return_lines",
            "product_returns",
            ["return_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_return_lines"):
        op.create_foreign_key(
            "fk_product_return_lines_sale_line_id",
            "product_return_lines",
            "sale_lines",
            ["sale_line_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_return_lines"):
        op.create_foreign_key(
            "fk_product_return_lines_tenant_id",
            "product_return_lines",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_serials"):
        op.create_foreign_key(
            "fk_product_serials_purchase_line_id",
            "product_serials",
            "purchase_lines",
            ["purchase_line_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_serials"):
        op.create_foreign_key(
            "fk_product_serials_sale_line_id",
            "product_serials",
            "sale_lines",
            ["sale_line_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_serials"):
        op.create_foreign_key(
            "fk_product_serials_warehouse_id",
            "product_serials",
            "warehouses",
            ["warehouse_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_warehouse_costs"):
        op.create_foreign_key(
            "fk_product_warehouse_costs_product_id",
            "product_warehouse_costs",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_warehouse_costs"):
        op.create_foreign_key(
            "fk_product_warehouse_costs_tenant_id",
            "product_warehouse_costs",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_warehouse_costs"):
        op.create_foreign_key(
            "fk_product_warehouse_costs_updated_by_movement_id",
            "product_warehouse_costs",
            "stock_movements",
            ["updated_by_movement_id"],
            ["id"],
    ...
    with op.batch_alter_table("product_warehouse_costs"):
        op.create_foreign_key(
            "fk_product_warehouse_costs_warehouse_id",
            "product_warehouse_costs",
            "warehouses",
            ["warehouse_id"],
            ["id"],
    ...
    with op.batch_alter_table("purchase_return_lines"):
        op.create_foreign_key(
            "fk_purchase_return_lines_product_id",
            "purchase_return_lines",
            "products",
            ["product_id"],
            ["id"],
    ...
    with op.batch_alter_table("purchase_return_lines"):
        op.create_foreign_key(
            "fk_purchase_return_lines_purchase_line_id",
            "purchase_return_lines",
            "purchase_lines",
            ["purchase_line_id"],
            ["id"],
    ...
    with op.batch_alter_table("purchase_return_lines"):
        op.create_foreign_key(
            "fk_purchase_return_lines_return_id",
            "purchase_return_lines",
            "purchase_returns",
            ["return_id"],
            ["id"],
    ...
    with op.batch_alter_table("purchase_return_lines"):
        op.create_foreign_key(
            "fk_purchase_return_lines_tenant_id",
            "purchase_return_lines",
            "tenants",
            ["tenant_id"],
            ["id"],
    ...
    with op.batch_alter_table("warranty_claims"):
        op.create_foreign_key(
            "fk_warranty_claims_sale_line_id",
            "warranty_claims",
            "sale_lines",
            ["sale_line_id"],
            ["id"],
