...
def upgrade():
    with op.batch_alter_table("campaigns", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key("campaigns_branch_id_fkey", "branches", ["branch_id"], ["id"], ondelete="CASCADE")
...
def downgrade():
    ...
    with op.batch_alter_table("campaigns", schema=None) as batch_op:
        batch_op.drop_constraint("campaigns_branch_id_fkey", type_="foreignkey")
