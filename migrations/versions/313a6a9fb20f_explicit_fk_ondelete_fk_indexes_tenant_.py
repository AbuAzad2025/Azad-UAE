...
def upgrade():
    ...
    with op.batch_alter_table('azad_subscription_fees', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_azad_subscription_fees_period', ['tenant_id', 'billing_period_start', 'billing_period_end'], unique=False)
    ...
    with op.batch_alter_table('bank_statement_lines', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(None, 'users', ['created_by'], ['id'], ondelete='RESTRICT')
        batch_op.create_foreign_key(None, 'gl_journal_entries', ['matched_journal_entry_id'], ['id'], ondelete='RESTRICT')
        batch_op.create_foreign_key(None, 'users', ['matched_by'], ['id'], ondelete='RESTRICT')
        batch_op.create_foreign_key(None, 'gl_accounts', ['bank_account_id'], ['id'], ondelete='RESTRICT')
        batch_op.create_foreign_key(None, 'bank_reconciliation_items', ['reconciliation_item_id'], ['id'], ondelete='RESTRICT')
    ...
    with op.batch_alter_table('fiscal_position_tax_rules', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_fiscal_position_tax_rules_destination_account_id'), ['destination_account_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_fiscal_position_tax_rules_destination_tax_id'), ['destination_tax_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_fiscal_position_tax_rules_source_account_id'), ['source_account_id'], unique=False)
    ...
    with op.batch_alter_table('partner_transactions', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(None, 'users', ['created_by'], ['id'], ondelete='RESTRICT')
        batch_op.create_foreign_key(None, 'partner_profit_distributions', ['distribution_id'], ['id'], ondelete='RESTRICT')
        batch_op.create_foreign_key(None, 'partners', ['partner_id'], ['id'], ondelete='RESTRICT')
    ...
    with op.batch_alter_table('pos_carts', schema=None) as batch_op:
        ...
        batch_op.create_index('idx_pos_cart_user_session_status', ['tenant_id', 'user_id', 'session_id', 'status'], unique=False)
    ...
    with op.batch_alter_table('pos_cash_movements', schema=None) as batch_op:
        ...
        batch_op.create_index('idx_pos_cash_movement_session', ['tenant_id', 'session_id', 'movement_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_pos_cash_movements_authorized_by_user_id'), ['authorized_by_user_id'], unique=False)
    ...
    with op.batch_alter_table('pos_override_tokens', schema=None) as batch_op:
        ...
        batch_op.create_index('idx_pos_override_token_cashier', ['tenant_id', 'cashier_user_id', 'action'], unique=False)
    ...
    with op.batch_alter_table('product_images', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_product_image_type_order', ['tenant_id', 'product_id', 'image_type', 'sort_order'], unique=False)
    ...
    with op.batch_alter_table('ticket_categories', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_ticket_categories_auto_assign_user_id'), ['auto_assign_user_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('stock_movements', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_stock_movements_warehouse_id'), 'warehouses', ['warehouse_id'], ['id'])

    with op.batch_alter_table('stock_batches', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('stock_batches_product_id_fkey'), 'products', ['product_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('stock_batches_warehouse_id_fkey'), 'warehouses', ['warehouse_id'], ['id'])

    with op.batch_alter_table('shop_wishlist', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_shop_wishlist_product_id'), 'products', ['product_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_shop_wishlist_account_id'), 'shop_customer_accounts', ['account_id'], ['id'])

    with op.batch_alter_table('shop_reviews', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_shop_reviews_product_id'), 'products', ['product_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_shop_reviews_account_id'), 'shop_customer_accounts', ['account_id'], ['id'])
    ...
    with op.batch_alter_table('shop_customer_accounts', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_shop_customer_accounts_customer_id'), 'customers', ['customer_id'], ['id'])
    ...
    with op.batch_alter_table('sales', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('idx_sales_tenant_date'), ['tenant_id', sa.literal_column('sale_date DESC')], unique=False)
    ...
    with op.batch_alter_table('salary_advances', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_salary_advances_gl_entry_id'), 'gl_journal_entries', ['gl_entry_id'], ['id'])
    ...
    with op.batch_alter_table('purchase_returns', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_purchase_returns_warehouse_id'), 'warehouses', ['warehouse_id'], ['id'])
    ...
    with op.batch_alter_table('purchase_return_lines', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_purchase_return_lines_product_id'), 'products', ['product_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_purchase_return_lines_purchase_line_id'), 'purchase_lines', ['purchase_line_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_purchase_return_lines_return_id'), 'purchase_returns', ['return_id'], ['id'])
    ...
    with op.batch_alter_table('products', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_products_category_id'), 'product_categories', ['category_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_products_merchant_customer_id'), 'customers', ['merchant_customer_id'], ['id'])
        ...
        batch_op.create_index(batch_op.f('idx_products_tenant_lower_sku'), ['tenant_id', sa.literal_column('lower(sku::text)')], unique=False)
        batch_op.create_index(batch_op.f('idx_products_fts_gin'), [sa.literal_column("to_tsvector('simple'::regconfig, (((((COALESCE(name, ''::character varying)::text || ' '::text) || COALESCE(name_ar, ''::character varying)::text) || ' '::text) || COALESCE(commercial_name, ''::character varying)::text) || ' '::text) || COALESCE(description, ''::text))")], unique=False, postgresql_using='gin')

    with op.batch_alter_table('product_warehouse_costs', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_product_warehouse_costs_updated_by_movement_id'), 'stock_movements', ['updated_by_movement_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_product_warehouse_costs_warehouse_id'), 'warehouses', ['warehouse_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_product_warehouse_costs_product_id'), 'products', ['product_id'], ['id'])
    ...
    with op.batch_alter_table('product_serials', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_product_serials_sale_line_id'), 'sale_lines', ['sale_line_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_product_serials_product_id'), 'products', ['product_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_product_serials_purchase_line_id'), 'purchase_lines', ['purchase_line_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_product_serials_warehouse_id'), 'warehouses', ['warehouse_id'], ['id'])
    ...
    with op.batch_alter_table('product_returns', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_product_returns_reverses_invoice_id'), 'sales', ['reverses_invoice_id'], ['id'])
    ...
    with op.batch_alter_table('product_return_lines', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_product_return_lines_product_id'), 'products', ['product_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_product_return_lines_return_id'), 'product_returns', ['return_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_product_return_lines_sale_line_id'), 'sale_lines', ['sale_line_id'], ['id'])

    with op.batch_alter_table('product_partners', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_product_partners_partner_customer_id'), 'customers', ['partner_customer_id'], ['id'])
    ...
    with op.batch_alter_table('product_images', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_product_image_type_order'), ['product_id', 'image_type', 'sort_order'], unique=False)

    with op.batch_alter_table('product_cost_history', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_product_cost_history_product_id'), 'products', ['product_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_product_cost_history_warehouse_id'), 'warehouses', ['warehouse_id'], ['id'])

    with op.batch_alter_table('product_categories', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_product_categories_parent_id'), 'product_categories', ['parent_id'], ['id'])
    ...
    with op.batch_alter_table('pos_override_tokens', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('pos_override_tokens_cashier_user_id_fkey'), 'users', ['cashier_user_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('pos_override_tokens_supervisor_user_id_fkey'), 'users', ['supervisor_user_id'], ['id'])
    ...
    with op.batch_alter_table('pos_cash_movements', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('pos_cash_movements_gl_entry_id_fkey'), 'gl_journal_entries', ['gl_entry_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('pos_cash_movements_authorized_by_user_id_fkey'), 'users', ['authorized_by_user_id'], ['id'])
        ...
        batch_op.create_index(batch_op.f('idx_pos_cash_movement_session'), ['session_id', 'movement_type'], unique=False)
    ...
    with op.batch_alter_table('pos_carts', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('idx_pos_cart_user_session_status'), ['user_id', 'session_id', 'status'], unique=False)
        batch_op.alter_column('updated_at',
               existing_type=postgresql.TIMESTAMP(),
               nullable=False)
    ...
    with op.batch_alter_table('payroll_transactions', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_payroll_transactions_gl_entry_id'), 'gl_journal_entries', ['gl_entry_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_payroll_transactions_employee_id'), 'employees', ['employee_id'], ['id'])
    ...
    with op.batch_alter_table('payment_transactions', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_payment_transactions_vault_id'), 'payment_vault', ['vault_id'], ['id'])
    ...
    with op.batch_alter_table('partner_transactions', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_partner_transactions_distribution_id'), 'partner_profit_distributions', ['distribution_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_partner_transactions_partner_id'), 'partners', ['partner_id'], ['id'])
    ...
    with op.batch_alter_table('partner_profit_distributions', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_partner_profit_distributions_approved_by'), 'users', ['approved_by'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_partner_profit_distributions_created_by'), 'users', ['created_by'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_partner_profit_distributions_partner_id'), 'partners', ['partner_id'], ['id'])
    ...
    with op.batch_alter_table('partner_commission_entries', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_partner_commission_entries_partner_customer_id'), 'customers', ['partner_customer_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_partner_commission_entries_branch_id'), 'branches', ['branch_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_partner_commission_entries_sale_line_id'), 'sale_lines', ['sale_line_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_partner_commission_entries_product_id'), 'products', ['product_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_partner_commission_entries_warehouse_id'), 'warehouses', ['warehouse_id'], ['id'])
    ...
    with op.batch_alter_table('journal_entry_audits', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_journal_entry_audits_journal_entry_id'), 'gl_journal_entries', ['journal_entry_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_journal_entry_audits_performed_by'), 'users', ['performed_by'], ['id'])
    ...
    with op.batch_alter_table('gl_journal_lines', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_gl_journal_lines_warehouse_id'), 'warehouses', ['warehouse_id'], ['id'])
        ...
        batch_op.create_foreign_key(batch_op.f('fk_gl_journal_lines_cost_center_id'), 'cost_centers', ['cost_center_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_gl_journal_lines_profit_center_id'), 'profit_centers', ['profit_center_id'], ['id'])
    ...
    with op.batch_alter_table('gl_journal_entries', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_gl_journal_entries_reversed_entry_id'), 'gl_journal_entries', ['reversed_entry_id'], ['id'])
        ...
        batch_op.create_index(batch_op.f('idx_gl_entries_tenant_date'), ['tenant_id', sa.literal_column('entry_date DESC')], unique=False)
    ...
    with op.batch_alter_table('fixed_assets', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_fixed_assets_cost_center_id'), 'cost_centers', ['cost_center_id'], ['id'])
        ...
        batch_op.create_foreign_key(batch_op.f('fk_fixed_assets_depreciation_account_id'), 'gl_accounts', ['depreciation_account_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_fixed_assets_asset_account_id'), 'gl_accounts', ['asset_account_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_fixed_assets_expense_account_id'), 'gl_accounts', ['expense_account_id'], ['id'])
    ...
    with op.batch_alter_table('fiscal_position_tax_rules', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_fiscal_position_tax_rules_source_tax_id'), 'tax_calculation_rules', ['source_tax_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_fiscal_position_tax_rules_destination_account_id'), 'gl_accounts', ['destination_account_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_fiscal_position_tax_rules_destination_tax_id'), 'tax_calculation_rules', ['destination_tax_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_fiscal_position_tax_rules_source_account_id'), 'gl_accounts', ['source_account_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_fiscal_position_tax_rules_fiscal_position_id'), 'fiscal_positions', ['fiscal_position_id'], ['id'])
    ...
    with op.batch_alter_table('expenses', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_expenses_category_id'), 'expense_categories', ['category_id'], ['id'])
    ...
    with op.batch_alter_table('depreciation_schedules', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_depreciation_schedules_journal_entry_id'), 'gl_journal_entries', ['journal_entry_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_depreciation_schedules_asset_id'), 'fixed_assets', ['asset_id'], ['id'])
    ...
    with op.batch_alter_table('customs_taxes', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_customs_taxes_gl_account_id'), 'gl_accounts', ['gl_account_id'], ['id'])

    with op.batch_alter_table('customers', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_customers_fiscal_position_id'), 'fiscal_positions', ['fiscal_position_id'], ['id'])
        ...
        batch_op.create_index(batch_op.f('idx_customers_fts_gin'), [sa.literal_column("to_tsvector('simple'::regconfig, (((((COALESCE(name, ''::character varying)::text || ' '::text) || COALESCE(name_ar, ''::character varying)::text) || ' '::text) || COALESCE(phone, ''::character varying)::text) || ' '::text) || COALESCE(email, ''::character varying)::text)")], unique=False, postgresql_using='gin')
    ...
    with op.batch_alter_table('bank_statement_lines', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_bank_statement_lines_bank_account_id'), 'gl_accounts', ['bank_account_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_bank_statement_lines_matched_cheque_id'), 'cheques', ['matched_cheque_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_bank_statement_lines_matched_journal_entry_id'), 'gl_journal_entries', ['matched_journal_entry_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_bank_statement_lines_created_by'), 'users', ['created_by'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_bank_statement_lines_reconciliation_item_id'), 'bank_reconciliation_items', ['reconciliation_item_id'], ['id'])
    ...
    with op.batch_alter_table('bank_reconciliations', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_bank_reconciliations_bank_account_id'), 'gl_accounts', ['bank_account_id'], ['id'])
    ...
    with op.batch_alter_table('bank_reconciliation_items', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_bank_reconciliation_items_reconciliation_id'), 'bank_reconciliations', ['reconciliation_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_bank_reconciliation_items_journal_entry_id'), 'gl_journal_entries', ['journal_entry_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_bank_reconciliation_items_cheque_id'), 'cheques', ['cheque_id'], ['id'])

    with op.batch_alter_table('azad_subscription_fees', schema=None) as batch_op:
        batch_op.drop_index('ix_azad_subscription_fees_period')
        batch_op.create_index(batch_op.f('ix_azad_subscription_fees_period'), ['billing_period_start', 'billing_period_end'], unique=False)
    ...
    with op.batch_alter_table('audit_logs', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('idx_audit_logs_tenant_created'), ['tenant_id', sa.literal_column('created_at DESC')], unique=False)
    ...
    with op.batch_alter_table('advanced_expenses', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('fk_advanced_expenses_category_id'), 'expense_categories', ['category_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_advanced_expenses_gl_journal_entry_id'), 'gl_journal_entries', ['gl_journal_entry_id'], ['id'])
        ...
        batch_op.create_foreign_key(batch_op.f('fk_advanced_expenses_supplier_id'), 'suppliers', ['supplier_id'], ['id'])
